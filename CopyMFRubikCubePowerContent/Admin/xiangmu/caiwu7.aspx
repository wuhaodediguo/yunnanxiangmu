<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true"
    CodeBehind="caiwu7.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.caiwu7" %>
    ...
    <div class="mainWrap clearfix">
        <div class="main_tit" style="height: 35px; margin-top: -10px;">
            <div>
                ...
                <font size="2px">财务管理</font>&gt;<font size="2px">结算管理</font> <em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</em>
            </div>
        </div>
        <div class="main_con">
                ...
                <div class="panel panel-default" style="width: 100%; height: 600px; overflow: auto;
                    ...
                    <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom: 0px;
                        ...
                        <h4 class="panel-title">
                            <strong><font color="blue" size="2px" font-weight="bold">结算管理列表</font></strong>
                        </h4>
                    </div>
                        ...
                        <div class="table-responsive" style="width: 100%">
                            <asp:GridView ID="GridView1" runat="server" Font-Size="12px" HeaderStyle-Height="10px"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="总支付金额" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl总支付金额" runat="server" Width="100px" Style="text-align: center;"
