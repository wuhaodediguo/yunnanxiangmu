<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true" CodeBehind="hezuo4.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.hezuo4" %>
            ...
            <div class="panel panel-default" style="width: 100%; height:600px; overflow: auto; margin-top: -5px;background-color:transparent;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom:0px; height: 35px; font-size: 10px;background-color: RGB(217,237,247); ">
                    <h4 class="panel-title" >
                       <strong><font color="blue" size="2px" font-weight="bold">施工队结算明细列表</font></strong> </h4>
                ...
                <div class="row" style="margin: 5px auto; font-size: 12px; width: 100%;">
                    ...
                    <div class="col-sm-1  ">
                        <asp:Button ID="Button1" runat="server" Text="导入" CssClass="btn11" Visible="false" OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                            OnClick="btnUpload_Click" />
                    </div>
                    <div class="col-sm-6 col-sm-offset-1">
                        <asp:Label ID="Label合计1" TabIndex="13" Width= "260px"  Style="margin-left: 0px; border:0; font-size:12px; color:red" 
                        ...
                        <asp:GridView ID="GridView1" runat="server" Font-Size="12px" HeaderStyle-Height="10px"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="ID" Visible="false" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblID" runat="server" Text='<%# Bind("col22") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="ID" Visible="false" >
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="项目部" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblcol1" runat="server" Text='<%# Bind("col1") %>' Width="120px" Style="text-align: center;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="施工年份" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol4" runat="server" Text='<%# Bind("col4") %>' Width="70px" Style="text-align: center;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="合同名称" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Left"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol23" runat="server" Text='<%# Bind("col23") %>' Width="70px" Style="text-align: Left;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="合同编号" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol24" runat="server" Text='<%# Bind("col24") %>' Width="70px" Style="text-align: center;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="单项工程名称" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Left"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblcol7" runat="server" Text='<%# Bind("col7") %>' Width="150px" Visible="false" Style="text-align: Left;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="结算金额" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="创建人" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol11" runat="server"  Text='<%# Bind("col20") %>' Width="70px"  ></asp:Label>
                                       </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="创建日期" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol12" runat="server"  Text='<%# Bind("col21") %>' Width="110px" ></asp:Label>
                                       </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="施工队单项工程结算电子档附件" HeaderStyle-CssClass="text-center">
                                        <ItemTemplate>
                                        <asp:LinkButton ID="lbtn1" runat="server"   Text="下载" Width="120px"
                                                         CommandName="lbtn11">
                                                         </asp:LinkButton>
                                            <asp:HyperLink ID="HyperLinkcol17" runat="server" NavigateUrl='<%# Eval("col17") %>'
                                                Target="_blank" Width="120px" Style="text-align: center;" Visible="false">下载</asp:HyperLink>
                                            <asp:Label ID="lbl施工队单项工程结算电子档附件" Visible="false" runat="server" Text='<%# Bind("col17") %>'></asp:Label>
                                            <asp:Label ID="Label施工队单项工程结算电子档附件" Visible="false" runat="server" Width="170px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                <asp:TemplateField HeaderText="施工队单项工程结算签字扫描附件" HeaderStyle-CssClass="text-center">
                                        <ItemTemplate>
                                        <asp:LinkButton ID="lbtn2" runat="server"   Text="下载" Width="180px"
                                                         CommandName="lbtn12">
                                                         </asp:LinkButton>
                                            <asp:HyperLink ID="HyperLinkcol18" runat="server" NavigateUrl='<%# Eval("col18") %>'
                                                Target="_blank" Width="120px" Style="text-align: center;" Visible="false">下载</asp:HyperLink>
                                            <asp:Label ID="lbl施工队单项工程结算签字扫描附件" Visible="false" runat="server" Text='<%# Bind("col18") %>'></asp:Label>
                                            <asp:Label ID="Label施工队单项工程结算签字扫描附件" Visible="false" runat="server" Width="180px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                <asp:TemplateField HeaderText="施工队合同扫描件" HeaderStyle-CssClass="text-center">
                                        <ItemTemplate>
                                        <asp:LinkButton ID="lbtn3" runat="server"   Text="下载" Width="120px"
                                                         CommandName="lbtn13">
                                                         </asp:LinkButton>
                                            <asp:HyperLink ID="HyperLinkcol19" runat="server" NavigateUrl='<%# Eval("col19") %>'
                                                Target="_blank" Width="120px" Style="text-align: center;" Visible="false">下载</asp:HyperLink>
                                            <asp:Label ID="lbl施工队合同扫描件" Visible="false" runat="server" Text='<%# Bind("col19") %>'></asp:Label>
                                            <asp:Label ID="Label施工队合同扫描件" Visible="false" runat="server" Width="120px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
 				<asp:TemplateField HeaderText="备注" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Left"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol10" runat="server" Text='<%# Bind("col10") %>' Width="120px" Style="text-align: Left;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
