...
{
    public partial class caiwu3 : System.Web.UI.Page
    {
        ...
        private void GridBind()
        {
            ...
            where.Append(" where 1=1 and col55 not like '%确定开票%' and col55 not like '%发票作废%' ");
            string sql = "select * from t_caiwu2 where 1= 1  and col55 not like '%确定开票%' and col55 not like '%发票作废%'  ";
            ...
            where.Append("  and (((col62 = '" + this.Session["FullName"].ToString() + "' or col63 like '%" + this.Session["FullName"].ToString() + "%' or col1 = '" + this.Session["FullName"].ToString() + "') and col8 = '施工合同' ) or (1 =1 and '" + this.Session["RoleValue"].ToString() + "' = '1') ) ");
            sql += " and  (((col62 = '" + this.Session["FullName"].ToString() + "' or col63 like '%" + this.Session["FullName"].ToString() + "%' or col1 = '" + this.Session["FullName"].ToString() + "') and col8 = '施工合同' )  or (1 =1 and '" + this.Session["RoleValue"].ToString() + "' = '1') ) ";
        ...
        protected void btn审核_Click(object sender, EventArgs e)
        {
            ...
            for (int k = 0; k < this.GridView1.Rows.Count; k++)
            {
                ...
                if (ifTick)
                {
                    ...
                    Response.Redirect("caiwu2.aspx?idno=" + tickedFormNo + "&id=" + tickedFormNo2 + "&temp1=" + temp1 + "&temp2=" + temp2 + "&temp3=" + temp3 + "&temp4=" + temp4 + "&temp5=" + temp5 + "&temp6=" + temp6 + "&temp7=" + temp7 + "&role=" + "审核", false);
                    break;
        ...
        protected void btn编辑_Click(object sender, EventArgs e)
        {
            ...
            for (int k = 0; k < this.GridView1.Rows.Count; k++)
            {
                ...
                if (ifTick)
                {
                    var ticked创建人 = ((Label)GridView1.Rows[k].FindControl("lblcol1")).Text;
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                ((HyperLink)e.Row.FindControl("HyperLink1")).NavigateUrl = "caiwu2.aspx?idno=" + tickedFormNo + "&id=" + tickedFormNo2 + "&temp1=" + temp1 + "&temp2=" + temp2 + "&temp3=" + temp3 + "&temp4=" + temp4 + "&temp5=" + temp5 + "&temp6=" + temp6 + "&temp7=" + temp7 + "&model=view";
        ...
        protected void btnExport2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dtAll.Rows.Count; i++)
            {
                ...
                var tickedcol53 = dtAll.Rows[i]["col53"].ToString();
                DataSet ds = Sql.SqlQueryDS("select * from t_caiwu22 where col18 = '" + tickedcol53 + "'");
                if (ds != null && ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                {
                    for (int ii = 0; ii < ds.Tables[0].Rows.Count; ii++)
                    {
                        ...
                        dr["A1"] = tickedcol53;
                        dr["A01"] = couint;
                        dr["A9"] = ds.Tables[0].Rows[ii]["col8"].ToString();
                        dr["A10"] = ds.Tables[0].Rows[ii]["col9"].ToString();
                        dr["A11"] = ds.Tables[0].Rows[ii]["col10"].ToString();
                        dr["A12"] = ds.Tables[0].Rows[ii]["col11"].ToString();
                        dr["A13"] = ds.Tables[0].Rows[ii]["col12"].ToString();
                        dr["A14"] = ds.Tables[0].Rows[ii]["col13"].ToString();
                        dr["A15"] = ds.Tables[0].Rows[ii]["col14"].ToString();
                        dr["A16"] = ds.Tables[0].Rows[ii]["col15"].ToString();
                        dr["A17"] = ds.Tables[0].Rows[ii]["col16"].ToString();
                        dr["A18"] = ds.Tables[0].Rows[ii]["col45"].ToString();
                        dr["A19"] = ds.Tables[0].Rows[ii]["col46"].ToString();

                        dr["A22"] = ds.Tables[0].Rows[ii]["col21"].ToString();
                        dr["A23"] = ds.Tables[0].Rows[ii]["col22"].ToString();
                        dr["A24"] = ds.Tables[0].Rows[ii]["col23"].ToString();
                        dr["A25"] = ds.Tables[0].Rows[ii]["col24"].ToString();
                        dr["A26"] = ds.Tables[0].Rows[ii]["col25"].ToString();
                        dr["A27"] = ds.Tables[0].Rows[ii]["col26"].ToString();
                        dr["A28"] = ds.Tables[0].Rows[ii]["col27"].ToString();
                        dr["A29"] = ds.Tables[0].Rows[ii]["col28"].ToString();
                        dr["A30"] = ds.Tables[0].Rows[ii]["col29"].ToString();
                        dr["A31"] = ds.Tables[0].Rows[ii]["col30"].ToString();
                        dr["A32"] = ds.Tables[0].Rows[ii]["col31"].ToString();
                        downloadTable.Rows.Add(dr);
                    }
