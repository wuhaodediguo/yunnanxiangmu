...
{
    public partial class xiangmu5 : System.Web.UI.Page
    {
        ...
        private void quanxian()
        {
            ...
            {
                div资料重提.Visible = true;
                div资料审核.Visible = true;
            }
        ...
        {
            Response.Redirect("xiangmu7.aspx", false);
        ...
        private void GridBind()
        {
            ...
            adminPager.TableName = "(select t_caiwu22.*,t_hetong.col8 as newcol8,t_hetong.col23 as newcol23,t_hetong.col26 as newcol26,t_hetong.col31 as newcol31,t_hetong.col34 as newcol34,t_hetong.col37 as newcol37 from t_caiwu22 inner join t_hetong on  t_caiwu22.col1 =  t_hetong.col1 and t_caiwu22.col2 = t_hetong.col2)";
        ...
        protected void btn查看_Click(object sender, EventArgs e)
        {
            ...
            for (int k = 0; k < this.GridView1.Rows.Count; k++)
            {
                ...
                if (ifTick)
                {
                    ...
                    Response.Redirect("xiangmu2Add.aspx?id=" + tickedFormNo + "&temp1=" + temp1 + "&temp2=" + temp2 + "&temp3=" + temp3 + "&temp4=" + temp4 + "&temp5=" + temp5 + "&temp6=" + temp6 + "&temp7=" + temp7 + "", false);
                    break;
                }
            }
        ...
        protected void btn资料审核_Click(object sender, EventArgs e)
        {
            ...
            for (int k = 0; k < this.GridView1.Rows.Count; k++)
            {
                ...
                if (ifTick)
                {
                    ...
                    Response.Redirect("xiangmu2Add.aspx?id=" + tickedFormNo + "&&model=shenhe&temp1=" + temp1 + "&temp2=" + temp2 + "&temp3=" + temp3 + "&temp4=" + temp4 + "&temp5=" + temp5 + "&temp6=" + temp6 + "&temp7=" + temp7 + "", false);
                    break;
                }
            }
