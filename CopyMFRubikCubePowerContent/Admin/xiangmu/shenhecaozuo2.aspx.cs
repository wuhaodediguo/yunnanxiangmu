...
{
    public partial class shenhecaozuo2 : System.Web.UI.Page
    {
        public static string txtquanxian = "";
        public static string fullname = "";
        public static string tickedFormNo = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = Sql.SqlQueryDS("select * from t_caiwu5 where ID = " + tickedFormNo + " ");
             if (ds != null && ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
             {
                 shenherenyuan = ds.Tables[0].Rows[0]["col43"].ToString();
             }
        ...
        protected void btn提交2_Click(object sender, EventArgs e)
        {
            ...
            List.col43 = fullname + " " + System.DateTime.Now.ToString("yyyy年-MM月-dd日 HH:mm分") + "已提交, " + TextBox审核人员.Text.Trim() + "未审核 ";

            List.col49 = this.Session["FullName"].ToString();
            List.col48 = TextBox审核人员value.Text;

            List.col50 = TextBox审核人员.Text + "," + this.Session["FullName"].ToString();
            List.col52 = TextBox审核意见.Text.Trim();

            List.col54 = tempszt; //状态
            List.UpdateDatashenhe2(int.Parse(tickedFormNo));

            zhuangtaiList list2 = new zhuangtaiList();
            string sql2 = "select * from t_zhuangtai where col1='" + List.col45 + "' and col2='" + List.col43 + "' ";
        ...
        protected void btn审核通过_Click(object sender, EventArgs e)
        {
            ...
            List.col43 = this.Session["FullName"].ToString() + " " + System.DateTime.Now.ToString("yyyy年-MM月-dd日 HH:mm分") + "审核通过," + TextBox审核意见.Text.Trim() + ";" + str新审核人员1;
        ...
        protected void btn审核不通过_Click(object sender, EventArgs e)
        {
            ...
            if (!shenherenyuan.Trim().Contains(TextBox审核人员 + "未审批"))
            {
            ...
            List.col43 = this.Session["FullName"].ToString() + " " + System.DateTime.Now.ToString("yyyy年-MM月-dd日 HH:mm分") + "审核不通过，" + TextBox审核意见.Text.Trim() + ";" + fullname + "继续修改!";
