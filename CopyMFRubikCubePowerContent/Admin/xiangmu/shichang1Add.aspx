<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true"
    CodeBehind="shichang1Add.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.shichang1Add" %>
            ...
            <div class="col-sm-12" style="width: 88%;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom: 0px; width:1080px;
                    ...
                    <h4 class="panel-title">
                        <strong><font color="blue" size="2px" >投标新增管理</font></strong>
                    </h4>
                </div>
                <div class="tab-content" style="margin: 0px auto; font-size: 9px;">
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblBox1" runat="server" class="form-control input-sm" Width="180px"
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblBox5" runat="server" class="form-control input-sm" Width="180px"
                                    Text="<font color='red'>*</font>投标人：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="5">
                                <asp:TextBox ID="TextBox投标人" TabIndex="16" Style="margin-left: 0px" Width="900px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label2" runat="server" class="form-control input-sm" Width="180px"
                                    Text="<font color='red'>*</font>报名起止日期：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox报名起止日期" TabIndex="19" Style="margin-left: 0px" Width="180px"
                            ...
                            <td>
                                <asp:Label ID="LabBox36" runat="server" class="form-control input-sm" Width="180px"
                                    Text="<font color='red'>*</font>至：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox至" TabIndex="20" Style="margin-left: 0px" Width="180px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onclick="WdatePicker({lang:'zh-cn',dateFmt:'yyyy年-MM月-dd日'})" ></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblBox9" runat="server" class="form-control input-sm" Width="180px"
                                    Text="<font color='red'>*</font>招标方式：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox招标方式" TabIndex="21" Style="margin-left: 0px" Width="180px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblBox开标日期2" runat="server" class="form-control input-sm" Width="180px"
                                    Text="<font color='red'>*</font>开标日期：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox开标日期" TabIndex="21" Style="margin-left: 0px" Width="180px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onclick="WdatePicker({lang:'zh-cn',dateFmt:'yyyy年-MM月-dd日'})"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox13" runat="server" class="form-control input-sm" Width="180px"
                                    Text="投标授权代表：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox投标授权代表" TabIndex="21" Style="margin-left: 0px" Width="180px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="TextBox2" runat="server" class="form-control input-sm" Width="180px"
                                    Text="缴纳报名费金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox缴纳报名费金额" TabIndex="21" Style="margin-left: 0px;text-align: right;" Width="180px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onblur='NumberCheck(this)'></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox21" runat="server" class="form-control input-sm" Width="180px"
                                    Text="报名费发票领取时间：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox报名费发票领取时间" TabIndex="21" Style="margin-left: 0px" Width="180px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onclick="WdatePicker({lang:'zh-cn',dateFmt:'yyyy年-MM月-dd日'})"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox25" runat="server" class="form-control input-sm" Width="180px"
                                    Text="缴纳投标保证金金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox缴纳投标保证金金额" TabIndex="21" Style="margin-left: 0px;text-align: right;" Width="180px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onblur='NumberCheck(this)'></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:TextBox ID="TextBox3" runat="server" class="form-control input-sm" Width="180px"
                                    Text="缴纳投标保证金形式：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox缴纳投标保证金形式" TabIndex="21" Style="margin-left: 0px" Width="180px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox8" runat="server" class="form-control input-sm" Width="180px"
                                    Text="缴纳投标保证金时间：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox缴纳投标保证金时间" TabIndex="21" Style="margin-left: 0px" Width="180px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onclick="WdatePicker({lang:'zh-cn',dateFmt:'yyyy年-MM月-dd日'})"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox1" runat="server" class="form-control input-sm" Width="180px"
                                    Text="投标保证金/保函到期时间：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox投标保证金保函到期时间" TabIndex="21" Style="margin-left: 0px" Width="180px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onclick="WdatePicker({lang:'zh-cn',dateFmt:'yyyy年-MM月-dd日'})"></asp:TextBox>
                            </td>
                         ...
                         <tr>
                             <td>
                                <asp:Label ID="lblBox23" runat="server" class="form-control input-sm" Width="180px"
                                    Text="<font color='red'>*</font>投标报名标段：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="5">
                                <asp:TextBox ID="TextBox投标报名标段" TabIndex="21" Style="margin-left: 0px" Width="900px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                         </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox11" runat="server" class="form-control input-sm" Width="180px"
                                    Text="投标保函开具银行：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox投标保函开具银行" TabIndex="21" Style="margin-left: 0px" Width="180px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox26" runat="server" class="form-control input-sm" Width="180px"
                                    Text="投标保证金退还金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox投标保证金退还金额" TabIndex="21" Style="margin-left: 0px;text-align: right;" Width="180px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onblur='NumberCheck(this)'></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox30" runat="server" class="form-control input-sm" Width="180px"
                                    Text="投标保证金保函退还日期：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox投标保证金保函退还日期" TabIndex="21" Style="margin-left: 0px" Width="180px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onclick="WdatePicker({lang:'zh-cn',dateFmt:'yyyy年-MM月-dd日'})"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                ...
                                <asp:TextBox ID="TextBox中标人" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox中标公示日期" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox中标通知书领取日期" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox中标标段" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox缴纳中标服务费金额" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox缴纳中标服务费日期" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox中标服务费发票领取时间" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox缴纳履约保证金金额" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox缴纳履约保证金形式" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox缴纳履约保证金时间" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox履约保函开具银行" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox履约保证金退还金额" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox履约保证金保函退还日期" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox中标通知书" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox履约保证金保函" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblTextBox7" runat="server" class="form-control input-sm" Width="180px"
                                    Height="52px" Text="<font color='red'>*</font>招标文件：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                ...
                                <asp:Button ID="Button2" runat="server" TabIndex="22" Text="上传" Style="font-size:12px;
                                    margin-left: 2px" OnClick="FileUpload招标文件Button_Click" CssClass="btn22" OnClientClick="RotateAnimation(this); return ShowProgressBar();"/>
                                <asp:TextBox ID="TextBox招标文件" runat="server" class="form-control input-sm" Style="display: none" Visible="false"></asp:TextBox>
                                <a href="" runat="server" id="招标文件href" target="_blank" style="font-size:12px;"></a>
                            ...
                            <td>
                                <asp:Label ID="lblTextBox6" runat="server" class="form-control input-sm" Width="180px"
                                    Height="52px" Text="<font color='red'>*</font>缴纳保证金保函：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                ...
                                <asp:Button ID="Button4" runat="server" TabIndex="22" Text="上传" Style="font-size:12px;
                                    margin-left: 2px" OnClick="FileUpload缴纳保证金保函Button_Click" CssClass="btn22" OnClientClick="RotateAnimation(this); return ShowProgressBar();"/>
                                <asp:TextBox ID="TextBox缴纳保证金保函" runat="server" class="form-control input-sm" Style="display: none" Visible="false"></asp:TextBox>
                                <a href="" runat="server" id="缴纳保证金保函href" target="_blank" style="font-size:12px;"></a>
                            ...
                            <td>
                                <asp:Label ID="lblTextBox4" runat="server" class="form-control input-sm" Width="180px"
                                    Height="52px" Text="<font color='red'>*</font>投标文件：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:FileUpload ID="MyFileUpload" runat="server" TabIndex="21" Width="178px" Style="margin-left: 2px" />
                                <asp:Button ID="Button3" runat="server" TabIndex="22" Text="上传" Style="font-size:12px;
                                    margin-left: 2px" OnClick="FileUpload投标文件Button_Click" CssClass="btn22" OnClientClick="RotateAnimation(this); return ShowProgressBar();"/>
                                <asp:TextBox ID="TextBox投标文件" runat="server" class="form-control input-sm" Style="display: none" Visible="false"></asp:TextBox>
                                <a href="" runat="server" id="投标文件href" target="_blank" style="font-size:12px;" Visible="false"></a>
                ...
                <div class="row">
                    <div class="col-sm-1 col-sm-offset-4">
                        <asp:Button ID="Button1" runat="server" Text="保存" TabIndex="37" CssClass="btn22"
