...
{
    public partial class caiwu8Add2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!base.IsPostBack)
            {
                ...
                tt1.Text = base.Request.QueryString["tt1"].ToString().Trim();
                tt2.Text = base.Request.QueryString["tt2"].ToString().Trim();
        ...
        string CreateNext()
        {
            ...
            sql = "select max(col8) as col8 from t_caiwu81 where 1=1 and col10 = '" + strdate + "' ";
        ...
        protected void btn保存_Click(object sender, EventArgs e)
        {
            ...
            if (this.TextBox本次申请支付金额.Text.Trim() == "")
            {
                this.AlertDiv.InnerHtml = MojoCube.Web.String.ShowAlert("danger", "请填写本次申请支付金额");
                return;
            }

            caiwu81List caiwu1List = new caiwu81List();
            caiwu1List.col1 = TextBox项目名称.Text.Trim();
            caiwu1List.col2 = TextBox项目编码.Text.Trim();
            caiwu1List.col3 = TextBox总包发票金额.Text.Trim();
            caiwu1List.col4 = TextBox总包到账金额.Text.Trim();
            caiwu1List.col5 = TextBox分包发票金额.Text.Trim();
            caiwu1List.col6 = TextBox已经支付金额.Text.Trim();
            caiwu1List.col7 = TextBox劳务单位开票金额.Text.Trim();
            caiwu1List.col8 = TextBox已经支付金额.Text.Trim();
            caiwu1List.col9 = TextBox本次申请支付金额.Text.Trim();
            caiwu1List.col10 = TextBox备注.Text.Trim();

            caiwu1List.col11 = hdNo2.Text;
            caiwu1List.col12 = TextBox结算单号.Text;
            caiwu1List.col13 = DateTime.Now.ToString("yyyyMMdd");
            caiwu1List.col14 = base.Request.QueryString["idno"];

            caiwu1List.InsertData();

            Response.Redirect("caiwu8Add.aspx?id=" + hdNo.Text + "&idno=" + base.Request.QueryString["idno"] + "&models=" + 1, false);
