<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true"
    CodeBehind="caiwu8Add2.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.caiwu8Add2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function QueryByWindowOpen(purpose, identity, preload, limit) {
            ...
            limit = 'tt1:' + document.getElementById('<%=tt1.ClientID %>').value + ',tt2:' + document.getElementById('<%=tt2.ClientID %>').value;
        ...
        function GetValueFromWindowOpen(object) {
            if (object.purpose == 'Alljiesuan') {
                ...
                var TextBox分包发票金额 = document.getElementById('<%= TextBox分包发票金额.ClientID %>');
                var TextBox分包到账金额 = document.getElementById('<%= TextBox分包到账金额.ClientID %>');
                var TextBox劳务单位开票金额 = document.getElementById('<%= TextBox劳务单位开票金额.ClientID %>');
                var TextBox已经支付金额 = document.getElementById('<%= TextBox已经支付金额.ClientID %>');

                var TextBox结算单号 = document.getElementById('<%= TextBox结算单号.ClientID %>');
                TextBox项目名称.value = object.col1;
                TextBox项目编码.value = object.col2;
                TextBox总包发票金额.value = object.col3;
                TextBox总包到账金额.value = object.col4;
                TextBox分包发票金额.value = object.col5;
                TextBox分包到账金额.value = object.col6;
                TextBox劳务单位开票金额.value = object.col7;
                TextBox已经支付金额.value = object.col8;
                TextBox结算单号.value = object.col9;
    ...
    <script type="text/javascript">
     ...
     <asp:TextBox ID="tt1" runat="server" class="form-control" Style="display: none"></asp:TextBox>
      <asp:TextBox ID="tt2" runat="server" class="form-control" Style="display: none"></asp:TextBox>
     <asp:TextBox ID="TextBox结算单号" runat="server" class="form-control" Style="display: none"></asp:TextBox>
            ...
            <div class="col-sm-12" style="width: 88%;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom: 0px;
                    ...
                    <h4 class="panel-title">
                        <strong><font color="blue" size="2px">新增付款项目明细</font></strong>
                    </h4>
                </div>
                <div class="tab-content" style="margin: 0px auto; font-size: 12px;">
                    <table>
                        <tr>
                            ...
                            <td colspan="3">
                                <div class="input-group">
                                    <asp:TextBox ID="TextBox项目名称" TabIndex="13" Style="margin-left: 0px" Width="917px"
                                    ...
                                    <span class="input-group-btn" runat="server" id="span1">
                                        <button type="button" class="btn btn-default btn-sm" onclick="QueryByWindowOpen('Alljiesuan','TextBox项目名称', true,'');">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="TextBox项目编码" TabIndex="14" Style="margin-left: 0px" Width="950"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox总包发票金额" TabIndex="16" Style="margin-left: 0px" Width="380"
                                    runat="server" class="form-control input-sm" autocomplete="off" onfocus="this.blur();"></asp:TextBox>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox总包到账金额" TabIndex="17" Style="margin-left: 0px" Width="380"
                                    runat="server" class="form-control input-sm" autocomplete="off" onfocus="this.blur();"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox分包发票金额" TabIndex="16" Style="margin-left: 0px" Width="380"
                                    runat="server" class="form-control input-sm" autocomplete="off" onfocus="this.blur();"></asp:TextBox>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox分包到账金额" TabIndex="17" Style="margin-left: 0px" Width="380"
                                    runat="server" class="form-control input-sm" autocomplete="off" onfocus="this.blur();"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox劳务单位开票金额" TabIndex="16" Style="margin-left: 0px" Width="380"
                                    runat="server" class="form-control input-sm" autocomplete="off" onfocus="this.blur();"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox10" runat="server" class="form-control input-sm" Width="190px"
                                    Text="已经支付金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox已经支付金额" TabIndex="17" Style="margin-left: 0px" Width="380"
                                    runat="server" class="form-control input-sm" autocomplete="off" onfocus="this.blur();"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:TextBox ID="TextBox25" runat="server" class="form-control input-sm" Width="190px"
                                     Text="本次申请支付金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td colspan="3">
                                <asp:TextBox ID="TextBox本次申请支付金额" TabIndex="14" Style="margin-left: 0px" Width="950px" onblur='NumberCheck5(this);'
