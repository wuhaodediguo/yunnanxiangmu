<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true"
    CodeBehind="caiwu6Add.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.caiwu6Add" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function QueryByWindowOpen(purpose, identity, preload, limit) {
            ...
            if (purpose == 'Allcaiwu22') {

                limit = 'htname:' + document.getElementById('<%=TextBox总包合同名称.ClientID %>').value + ',htno:' + document.getElementById('<%=TextBox总包合同编号.ClientID %>').value;
            ...
            if (purpose == 'Alljine') {
                ...
                limit = document.getElementById('<%=TextBoxxiangmuid.ClientID %>').value;
        ...
        function GetValueFromWindowOpen(object) {
            ...
            if (object.purpose == 'Allcaiwu22') {

                if (object.identity == 'TextBox总包项目名称') {
                    var TextBox总包项目名称 = document.getElementById('<%= TextBox总包项目名称.ClientID %>');
                    TextBox总包项目名称.value = object.col1;
                    var TextBox总包项目编码 = document.getElementById('<%= TextBox总包项目编码.ClientID %>');
                    TextBox总包项目编码.value = object.col2;
                    var TextBoxxiangmuid = document.getElementById('<%= TextBoxxiangmuid.ClientID %>');
                    TextBoxxiangmuid.value = object.id;
            ...
            if (object.purpose == 'Alljine') {
                var TextBox总包发票金额 = document.getElementById('<%= TextBox总包发票金额.ClientID %>');
                TextBox总包发票金额.value = object.col2;
                var TextBox总包到账金额 = document.getElementById('<%= TextBox总包到账金额.ClientID %>');
                TextBox总包到账金额.value = object.col8;
            }
        ...
        function LinkPrintPage() {
            ...
            window.open('/Admin/xiangmu/shenhecaozuo2.aspx?txtquanxian=' + txtquanxian + "&&fullname=" + fullname + "&&aaa=" + aaa + "&&tickedFormNo=" + tickedFormNo + "&&getid11=" + getid11,
    ...
    <script type="text/javascript">
        ...
        function LinkPrintPage2() {
            ...
            window.open("../xiangmu/print4.aspx?idno=" + hdidno + "&id=" + hdid + "&hdRoleValue=" + hdRoleValue);
                ...
                <dl style="width: 120px; height: 100%;">
                    ...
                    <dd runat="server" id="dd0091">
                        <a runat="server" id="div0091" href="caiwu6.aspx?models=1"><font color="blue">
                            <asp:Label ID="Label11" runat="server" Text="结算申请" Font-Size="14px"></asp:Label></font></a></dd>
                    <dd runat="server" id="dd0092">
                        <a runat="server" id="div0092" href="caiwu6.aspx?models=2"><font color="blue">
                            <asp:Label ID="Label12" runat="server" Text="结算审核" Font-Size="14px"></asp:Label></font></a></dd>
                    <dd runat="server" id="dd0093">
                        <a runat="server" id="div0093" href="caiwu7.aspx"><font color="blue">
                            <asp:Label ID="Label13" runat="server" Text="结算管理" Font-Size="14px"></asp:Label></font></a></dd>
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom: 0px;
                    ...
                    <h4 class="panel-title">
                        <strong><font color="blue" size="2px">
                            <asp:Label ID="lbl结算Box2" Text="结算新增管理" runat="server"></asp:Label></font></strong>
                    </h4>
                </div>
                <div class="tab-content" id="div01" style="margin: 0px auto; font-size: 12px;">
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                <div class="input-group">
                                    <asp:TextBox ID="TextBox总包合同名称" TabIndex="13" Style="margin-left: 0px" Width="917px"
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <asp:TextBox ID="TextBox总包合同编号" TabIndex="15" Style="margin-left: 0px" Width="380px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onfocus="this.blur();"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblBox13" runat="server" class="form-control input-sm" Width="190px"
                                    Text="总包合同金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="TextBox总包合同金额" TabIndex="16" Style="margin-left: 0px" Width="380px"
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblBox12" runat="server" class="form-control input-sm" Width="190px"
                                    Text="建设单位名称：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="TextBox建设单位名称" TabIndex="17" Style="margin-left: 0px" Width="380px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onfocus="this.blur();"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblBox15" runat="server" class="form-control input-sm" Width="190px"
                                    Text="施工单位名称：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="TextBox施工单位名称" TabIndex="17" Style="margin-left: 0px" Width="380px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onfocus="this.blur();"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblBox35" runat="server" class="form-control input-sm" Width="190px"
                                    Text="<font color='red'>*</font>分包合同名称：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="5">
                                <asp:TextBox ID="TextBox分包合同名称" TabIndex="13" Style="margin-left: 0px" Width="950px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label1" runat="server" class="form-control input-sm" Width="190px"
                                    Height="52px" Text="<font color='red'>*</font>分包合同结算依据：" Font-Bold="true" ReadOnly="true"
                                    Style="text-align: right; background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="5">
                                <asp:TextBox ID="TextBox分包合同结算依据" TabIndex="13" Style="margin-left: 0px" Width="950px"
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblBox34" runat="server" class="form-control input-sm" Width="190px"
                                    Text="<font color='red'>*</font>分包单位名称：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox分包单位" TabIndex="11" Style="margin-left: 0px" Width="200px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblBox36" runat="server" class="form-control input-sm" Width="180px"
                                    Text="<font color='red'>*</font>分包合同金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox分包合同金额" TabIndex="11" Style="margin-left: 0px" Width="190px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblBox37" runat="server" class="form-control input-sm" Width="180px"
                                    Text="<font color='red'>*</font>分包合同签订日期：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox分包合同签订日期" TabIndex="13" Style="margin-left: 0px" Width="200px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label2" runat="server" class="form-control input-sm" Width="190px"
                                    Text="<font color='red'>*</font>分包合同结算比例：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="TextBox分包合同结算比例" TabIndex="11" Style="margin-left: 0px" Width="380px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="Label3" runat="server" class="form-control input-sm" Width="190px"
                                    Text="<font color='red'>*</font>分包合同编号：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="TextBox分包合同编号" TabIndex="13" Style="margin-left: 0px" Width="380px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblBox24" runat="server" class="form-control input-sm" Width="190px"
                                    Text="<font color='red'>*</font>劳务合同名称：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="5">
                                <asp:TextBox ID="TextBox劳务合同名称" TabIndex="13" Style="margin-left: 0px" Width="950px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="5">
                                <asp:TextBox ID="TextBox劳务合同结算依据" TabIndex="13" Style="margin-left: 0px" Width="950px"
                                    Height="52px" Rows="2" TextMode="MultiLine" runat="server" class="form-control input-sm"
                                    autocomplete="off"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox劳务单位" TabIndex="14" Style="margin-left: 0px" Width="200px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblBox30" runat="server" class="form-control input-sm" Width="180px"
                                    Text="<font color='red'>*</font>劳务合同金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox劳务合同金额" TabIndex="14" Style="margin-left: 0px" Width="190px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblBox4" runat="server" class="form-control input-sm" Width="180px"
                                    Text="<font color='red'>*</font>劳务合同签订日期：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox劳务合同签订日期" TabIndex="13" Style="margin-left: 0px" Width="200px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label4" runat="server" class="form-control input-sm" Width="190px"
                                    Text="<font color='red'>*</font>劳务合同结算比例：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="TextBox劳务合同结算比例" TabIndex="11" Style="margin-left: 0px" Width="380px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="TextBox22" runat="server" class="form-control input-sm" Width="190px"
                                    Text="总包项目名称：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td colspan="5">
                                <div class="input-group">
                                    <asp:TextBox ID="TextBox总包项目名称" TabIndex="13" Style="margin-left: 0px" Width="917px"
                                        runat="server" class="form-control input-sm" autocomplete="off" onfocus="this.blur();"></asp:TextBox>
                                    <span class="input-group-btn" runat="server" id="span总包项目名称">
                                        <button type="button" class="btn btn-default btn-sm" onclick="QueryByWindowOpen('Allcaiwu22','TextBox总包项目名称', true,'合作合同');">
                                            <span class="glyphicon glyphicon-search" aria-hidden="true" align="left"></span>
                                        </button>
                                    </span>
                                </div>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblBox16" runat="server" class="form-control input-sm" Width="190px"
                                    Text="总包项目编码：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <div class="input-group">
                                    <asp:TextBox ID="TextBox总包项目编码" TabIndex="23" Style="margin-left: 0px" Width="380px"
                                        onfocus="this.blur();" runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                                </div>
                            </td>
                            <td>
                                <asp:Label ID="lblBox18" runat="server" class="form-control input-sm" Width="190px"
                                    Text="总包发票金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <div class="input-group">
                                    <asp:TextBox ID="TextBox总包发票金额" TabIndex="13" Style="margin-left: 0px" Width="347px"
                                        runat="server" class="form-control input-sm" autocomplete="off" onfocus="this.blur();"></asp:TextBox>
                                    <span class="input-group-btn" runat="server" id="span总包发票金额">
                                        <button type="button" class="btn btn-default btn-sm" onclick="QueryByWindowOpen('Alljine','TextBox总包发票金额', true,'');">
                                            <span class="glyphicon glyphicon-search" aria-hidden="true" align="left"></span>
                                        </button>
                                    </span>
                                </div>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblBox6" runat="server" class="form-control input-sm" Width="190px"
                                    Text="总包到账金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="TextBox总包到账金额" TabIndex="25" Style="margin-left: 0px" Width="380px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onblur='NumberCheck(this)'></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblBox20" runat="server" class="form-control input-sm" Width="190px"
                                    Text="分包发票金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="TextBox分包发票金额" TabIndex="26" Style="margin-left: 0px" Width="380px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onblur='NumberCheck(this)'></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblBox21" runat="server" class="form-control input-sm" Width="190px"
                                    Text="分包到账金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="TextBox分包到账金额" TabIndex="27" Style="margin-left: 0px" Width="380px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onblur='NumberCheck(this)'></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblBox26" runat="server" class="form-control input-sm" Width="190px"
                                    Text="劳务单位开票金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="TextBox劳务单位开票金额" TabIndex="28" Style="margin-left: 0px" Width="380px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onblur='NumberCheck(this)'></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:TextBox ID="TextBox1" runat="server" class="form-control input-sm" Width="190px"
                                    Height="66px" Text="结算依据：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td colspan="5">
                                <asp:TextBox ID="TextBox结算依据" TabIndex="39" Style="margin-left: 0px" Width="950px"
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                <asp:TextBox ID="TextBox备注" TabIndex="39" Style="margin-left: 0px" Width="950px"
                                    TextMode="MultiLine" Rows="3" runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblTextBox28" runat="server" class="form-control input-sm" Width="190px"
                            ...
                            <td>
                                <asp:Label ID="lblTextBox36" runat="server" class="form-control input-sm" Width="190px"
                                    Height="52px" Text="<font color='red'>*</font>项目实施单位结算附件：" Font-Bold="true" ReadOnly="true"
                                    Style="text-align: right; background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:FileUpload ID="FileUpload2" runat="server" TabIndex="35" Style="margin-left: 1px;" />
                    ...
                    <div runat="server" id="divGridView1" visible="false" class="table-responsive" style="width: 1140px;
                        margin-top: 1px;">
                        <asp:GridView ID="GridView1" runat="server" Font-Size="12px" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="收款人" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="left">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol34" runat="server" Text='<%# Bind("col4") %>' Width="180PX"
                                            Style="text-align: left; border: 0;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="开户行" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="left">
                                    <ItemTemplate>
                                        <div>
                                            <asp:Label ID="lblcol35" runat="server" Text='<%# Bind("col5") %>' Width="200px"
                                                Style="text-align: left; border: 0;" autocomplete="off"></asp:Label>
                                        </div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="银行账号" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="left">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol36" runat="server" Text='<%# Bind("col6") %>' Width="150px"
                                            Style="text-align: left; border: 0;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="备注" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="left">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol37" runat="server" Text='<%# Bind("col7") %>' Width="150px"
                                            Style="text-align: left; border: 0;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="TextBox审批状态" TabIndex="39" Style="margin-left: 0px; margin-top: 1px;
                                    word-wrap: break-word; height: 66px; word-break: break-all;" Width="950px" TextMode="MultiLine"
                    ...
                    <table id="div审批意见" runat="server" visible="false">
                        <tr>
                            <td>
                                <asp:Label ID="lblTextBox1" runat="server" class="form-control input-sm" Width="190px"
