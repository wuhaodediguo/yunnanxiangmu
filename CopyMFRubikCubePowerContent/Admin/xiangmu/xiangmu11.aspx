<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true" CodeBehind="xiangmu11.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.xiangmu11" %>
            ...
            <div class="panel panel-default" style="width: 100%; height:600px;overflow: auto; margin-top: -5px;background-color:transparent;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom:0px; height: 35px; font-size: 10px;background-color: RGB(217,237,247); ">
                    <h4 class="panel-title" >
                       <strong><font color="blue" size="2px" font-weight="bold">项目未审计明细列表</font></strong> </h4>
                ...
                <div class="row" style="margin: 5px auto; font-size: 12px; width: 100%;">
                    ...
                    <div class="col-sm-1 ">
                        <asp:Button ID="Button3" runat="server" Text="审计确认" CssClass="btn11" Width="70px"  OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                            OnClick="btn编辑_Click" />
                    </div>
                    <div class="col-sm-2 ">
                        <asp:Button ID="Button1" runat="server" Text="项目已审计明细" CssClass="btn11" Width="110px"  OnClick="btn项目已审计明细_Click" />
                    </div>
                    <div class="col-sm-1 ">
                        ...
                        <asp:GridView ID="GridView1" runat="server" Font-Size="12px" HeaderStyle-Height="10px"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="创建人" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol13" runat="server" Text='<%# Bind("col19") %>' Width="90px"
                                            Style="text-align: center;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="创建日期" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol14" runat="server" Text='<%# Bind("col20") %>' Width="110px"
                                            Style="text-align: center;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
