<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true" CodeBehind="caiwu31.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.caiwu31" %>
    ...
    <div class="mainWrap clearfix">
        <div class="main_tit" style="height:35px; margin-top:-10px;">
            <div>
                ...
                <font size="2px">财务管理</font>&gt;<font size="2px">税款管理</font>
                <em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</em>
            </div>
        </div>
        <div class="main_con">
            ...
            <div class="col-sm-12" style="width: 88%; height: 600px;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom: 0px;
                        ...
                        <h4 class="panel-title">
                            <strong><font color="blue" size="2px" font-weight="bold">未缴税款明细列表</font></strong>
                        </h4>
                    </div>
                ...
                <div class="row" style="margin: 5px auto; font-size: 12px; width: 100%; ">
                    ...
                    <div class="col-sm-1">
                        <asp:Button ID="Button3" runat="server" Text="缴税" CssClass="btn11" OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                            OnClick="btn编辑_Click" />
                    </div>
                    <div class="col-sm-1">
                        <asp:Button ID="btnAdd" runat="server" Text="已缴税明细" CssClass="btn11" Width="75" OnClick="btn缴税明细_Click"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="开票申请单号" HeaderStyle-CssClass="text-center" >
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblcol53" runat="server" Text='<%# Bind("col53") %>' Visible="false" Width="140px" Style="text-align: left;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="付款单位名称" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="right"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol14" runat="server" Text='<%# Bind("col14") %>' Width="120px" Style="text-align: right;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="备注" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="left"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol49" runat="server" Text='<%# Bind("col65") %>' Width="150px"
                                            Style="text-align: left;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
