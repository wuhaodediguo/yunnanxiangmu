<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true" CodeBehind="xiangmu31Add.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.xiangmu31Add" %>
            ...
            <div class="col-sm-12" style="width: 88%;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom: 0px; width:1120px;
                    ...
                    <h4 class="panel-title">
                        <strong><font color="blue" size="2px" ><asp:Label runat="server" ID= "txttitles" Text="项目综合管理列表►查看"></asp:Label></font></strong>
                    </h4>
                </div>
                ...
                <div class="tab-content" style="margin: 0px auto; font-size: 12px;">
                        ...
                        <RowStyle HorizontalAlign="Center" CssClass="" VerticalAlign="Middle"   />
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="发票申请单号" HeaderStyle-CssClass="text-center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lbl发票申请单号" runat="server" Text=' <%# Bind("A11") %>' Width="130px"  style=" text-align:center;font-size:12px"> </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="开票不含税金额"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol541" runat="server" Text='<%# Bind("A12") %>' Width="90px"  style=" text-align:center;"
                                ...
                                <asp:TemplateField HeaderText="开票含税金额"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol54" runat="server" Text='<%# Bind("A2") %>' Width="90px"  style=" text-align:center;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="发票类型"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol19" runat="server" Text='<%# Bind("A4") %>' Width="90px"  style=" text-align:center;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="发票类别"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol20" runat="server" Text='<%# Bind("A5") %>' Width="90px"  style=" text-align:center;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="税率"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol14" runat="server" Text='<%# Bind("A6") %>' Width="70px"  style=" text-align:center;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="到账金额"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol43" runat="server" Text='<%# Bind("A8") %>' Width="80px"  style=" text-align:center;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                    ...
                    <br />
                    <div id="Div1" runat="server"  style="width: 1120px; height: 180px; overflow: auto;
                            ...
                            <asp:GridView ID="GridView2" runat="server" Font-Size="12px" DefaultType="1" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="发票单号" HeaderStyle-CssClass="headtile" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblID2" runat="server" Text='<%# Bind("ID2") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="附件类型" HeaderStyle-CssClass="headtile" >
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-CssClass="headtile" HeaderText="操作">
                                        <ItemTemplate>
                                           <asp:LinkButton ID="lbtn2" runat="server" Text="下载" Width="120px" CommandName="lbtn11">
                                        </asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
