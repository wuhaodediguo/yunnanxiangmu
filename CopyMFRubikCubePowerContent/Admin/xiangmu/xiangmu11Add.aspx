<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true" CodeBehind="xiangmu11Add.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.xiangmu11Add" %>
 ...
 .td2{   
    ...
    <script type="text/javascript">
        ...
        function tongji() {
            ...
            var Drop税率 = document.getElementById('<%= Drop税率1.ClientID %>').value.replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "");

            var amount1 = 0;
            var amount2 = 0;
            var amount3 = 0;

            var TextBox结算金额不含税 = document.getElementById('<%= TextBox结算金额不含税.ClientID %>').value.replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "");
            var TextBox税额 = document.getElementById('<%= TextBox税额1.ClientID %>');
            var TextBox结算金额含税 = document.getElementById('<%= TextBox结算金额含税.ClientID %>');

            if (TextBox结算金额不含税) {
                amount1 = formatAsNum(TextBox结算金额不含税);
            }
            ...
            TextBox结算金额不含税.value = formatNumberHeader(amount1);
            TextBox税额.value = formatNumberHeader(amount1 * amount3);
            TextBox结算金额含税.value = formatNumberHeader(amount1 * (1 + amount3));
        ...
        function tongji2() {
            ...
            var Drop税率 = document.getElementById('<%= Drop税率2.ClientID %>').value.replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "");

            var amount1 = 0;
            var amount2 = 0;
            var amount3 = 0;

            var TextBox审定金额不含税 = document.getElementById('<%= TextBox审定金额不含税.ClientID %>').value.replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "");
            var TextBox税额 = document.getElementById('<%= TextBox税额2.ClientID %>');
            var TextBox审定金额含税 = document.getElementById('<%= TextBox审定金额含税.ClientID %>');

            if (TextBox审定金额不含税) {
                amount1 = formatAsNum(TextBox审定金额不含税);
            }
            ...
            TextBox审定金额不含税.value = formatNumberHeader(amount1);
            TextBox税额.value = formatNumberHeader(amount1 * amount3);
            TextBox审定金额含税.value = formatNumberHeader(amount1 * (1 + amount3));
            ...
            <div class="main_conL222" style="width: 12%; background-color: RGB(155,194,230); 
                ...
                <dl style="width: 120px; height: 100%;">
                    ...
                    <dd runat="server" id="dd0046">
                        ...
                        <font color="blue">
                            <asp:Label ID="Label119" runat="server" Text="项目月报管理" Font-Size="14px"></asp:Label></font></a></dd>
                </dl>
            </div>
            <div class="col-sm-12" style="width: 88%;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom: 0px; width:1120px;
                    ...
                    <h4 class="panel-title">
                        <strong><font color="blue" size="2px" >项目审计确认管理</font></strong>
                    </h4>
                </div>
                ...
                <div class="tab-content" style="margin: 0px auto; font-size: 10px;">
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblBox3" runat="server" class="form-control input-sm" Width="140px"
                                    Text="<font color='red'>*</font>建设单位：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox建设单位" TabIndex="13" Style="margin-left: 0px" Width="420px" onfocus="this.blur();"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblBox4" runat="server" class="form-control input-sm" Width="140px"
                                    Text="<font color='red'>*</font>施工单位：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox施工单位" TabIndex="14" Style="margin-left: 0px" Width="420px" onfocus="this.blur();"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox项目经理" TabIndex="11" Style="margin-left: 0px" Width="420px" onfocus="this.blur();"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblBox7" runat="server" class="form-control input-sm" Width="140px"
                                    Text="<font color='red'>*</font>单项工程名称：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label1" runat="server" class="form-control input-sm" Width="140px"
                                    Text="<font color='red'>*</font>结算类型：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="3">
                                <asp:DropDownList ID="Drop结算类型" TabIndex="18" Style="margin-left: 0px" Width="980px" 
                                    runat="server" class="form-control input-sm" autocomplete="off">
                                    <asp:ListItem>施工费</asp:ListItem>
                                    <asp:ListItem>材料费</asp:ListItem>
                                    <asp:ListItem>安全生产费</asp:ListItem>
                                    <asp:ListItem>服务费</asp:ListItem>    
                                </asp:DropDownList>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="Drop税率1" TabIndex="25" Style="margin-left: 0px" Width="140px"  onchange='tongji();'
                                    runat="server" class="form-control input-sm" autocomplete="off">
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label2" runat="server" class="form-control input-sm" Width="140px"
                                    Text="<font color='red'>*</font>审定金额(不含税)：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:DropDownList ID="Drop税率2" TabIndex="25" Style="margin-left: 0px" Width="140px"  onchange='tongji2();'
                                    runat="server" class="form-control input-sm" autocomplete="off">
                                    <asp:ListItem></asp:ListItem>
                                    <asp:ListItem>0%</asp:ListItem>
                                    <asp:ListItem>3%</asp:ListItem>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <asp:TextBox ID="TextBox开票金额" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox货物服务名称" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox发票类型" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox发票类别" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox开票日期" runat="server" class="form-control" Style="display: none"></asp:TextBox>

                                <asp:TextBox ID="TextBox发票扫描件" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox采购订单扫描件" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox完工结算证明扫描件" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox11" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                                <asp:TextBox ID="TextBox竣工资料及图纸附件" runat="server" class="form-control" Style="display: none"></asp:TextBox>
                        ...
                        <tr runat="server" visible="false">
                            <td>
                                <asp:Label ID="Label13" runat="server" class="form-control input-sm" Width="140px" Height="52px"
                            ...
                            <td colspan="3">
                                 <asp:FileUpload ID="FileUpload4" TabIndex="31" runat="server" Style="margin-left: 1px; width:179px" />
                                    <asp:Button ID="Button1" runat="server" Text="上传" TabIndex="32" Style="font-size: 12px;margin-left: 1px"
                                        OnClick="FileUpload审计定案扫描件Button_Click" CssClass="btn22" />
                            ...
                            <td colspan="2">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField  HeaderStyle-CssClass="text-center">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink1" runat="server" Text='<%# Bind("col3") %>' CssClass="td2"  NavigateUrl='<%# Bind("col3") %>' Width="260"  ></asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderStyle-CssClass="text-center">
                                            <ItemTemplate>
