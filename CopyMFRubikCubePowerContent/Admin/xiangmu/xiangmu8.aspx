<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true" CodeBehind="xiangmu8.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.xiangmu8" %>
            ...
            <div class="panel panel-default" style="width: 100%; height:600px;overflow: auto; margin-top: -5px;background-color:transparent;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom:0px; height: 35px; font-size: 10px;background-color: RGB(217,237,247); ">
                    <h4 class="panel-title" >
                       <strong><font color="blue" size="2px" font-weight="bold">项目部项目月报明细列表</font></strong> </h4>
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="TextBox5" runat="server" class="form-control input-sm"
                                            Width="120px" Text="年度：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox8" runat="server" class="form-control input-sm" 
                                            Width="120px" Text="月份：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                            background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:TextBox>
                                    </td>
                                   <td colspan="3">
                ...
                <div class="row" style="margin: 5px auto; font-size: 12px; width: 100%;">
                    <%--<div class="col-sm-1  ">
                        <asp:Button ID="Button7" runat="server" Text="项目月报--月份" CssClass="btn11" Width="100"  OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                            OnClick="btn月份_Click" />
                    </div>
                    <div class="col-sm-1  ">
                        <asp:Button ID="Button8" runat="server" Text="项目月报--项目部" CssClass="btn11" Width="120"  OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                            OnClick="btn项目部_Click" />
                    </div>--%>
                    <div class="col-sm-1 ">
                    ...
                    <div class="col-sm-1 ">
                        <asp:Button ID="Button3" runat="server" Text="新建" CssClass="btn11"   OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                            OnClick="btnAdd_Click" />
                    </div>
                   <div class="col-sm-1 ">
                        <asp:Button ID="Button8" runat="server" Text="编辑" CssClass="btn11"   OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                            OnClick="btn编辑_Click" />
                    </div>
                    <div class="col-sm-1 ">
                    ...
                    <div class="col-sm-1 ">
                            <asp:Button ID="Button7" runat="server" Text="返回" CssClass="btn11" OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                                OnClick="btn返回_Click" />
                    </div>
                   <%-- <div class="col-sm-6 col-sm-offset-1">
                        ...
                        <asp:Label ID="Label合计2" TabIndex="13" Width= "260px" Style="margin-left: 0px; border:0;font-size:12px; color:red;"  
                        runat="server" class="form-control input-sm" autocomplete="off" ></asp:Label>
                    </div>--%>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="项目名称" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblcol8" runat="server" Text='<%# Bind("col8") %>' Width="120px" Visible="false" Style="text-align: Left;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="站点名称" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="完成工作内容" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol12" runat="server" CssClass="td2" Text='<%# Bind("col12") %>' Width="300px" ToolTip='<%# Bind("col12") %>' 
                                            Style="text-align: Left;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="本月已经开票金额" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol13" runat="server" Text='<%# Bind("col13") %>' Width="100px"
                                            Style="text-align: center;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="下月计划开票金额" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol14" runat="server" Text='<%# Bind("col14") %>' Width="100px"
                                            Style="text-align: center;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                
                                <asp:TemplateField HeaderText="完成情况" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol15" runat="server" Text='<%# Bind("col15") %>' Width="100px"
                                            Style="text-align: center;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="验收情况" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol16" runat="server" Text='<%# Bind("col16") %>' Width="100px"
                                            Style="text-align: center;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="创建人" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol17" runat="server" Text='<%# Bind("col17") %>' Width="90px"
                                            Style="text-align: center;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="备注" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="left" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol19" runat="server" Text='<%# Bind("col19") %>' Width="150px"
