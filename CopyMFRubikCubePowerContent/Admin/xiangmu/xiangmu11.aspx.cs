...
{
    public partial class xiangmu11 : System.Web.UI.Page
    {
        ...
        private void GridBind()
        {
            ...
            where.Append(" where 1=1 and (t_xiangmu1.col15 is null or t_xiangmu1.col15 = '') ");
            string sql = "select * from (select t_xiangmu1.*,t_hetong.col8 as newcol8,t_hetong.col23 as newcol23,t_hetong.col26 as newcol26,t_hetong.col31 as newcol31,t_hetong.col34 as newcol34,t_hetong.col37 as newcol37  from t_xiangmu1 inner join t_hetong on  t_xiangmu1.col1 =  t_hetong.col1 and t_xiangmu1.col2 = t_hetong.col2) where 1= 1 and (t_xiangmu1.col15 is null or t_xiangmu1.col15 = '') ";
            ...
            where.Append(" and (col15 is null or col15 = '') ");
            sql += " and (col15 is null or col15 = '') ";
        ...
        protected void btn项目已审计明细_Click(object sender, EventArgs e)
        {
            Response.Redirect("xiangmu6.aspx", false);
        }
        ...
        protected void btn编辑_Click(object sender, EventArgs e)
        {
            ...
            for (int k = 0; k < this.GridView1.Rows.Count; k++)
            {
                ...
                if (ifTick)
                {
                    ...
                    Response.Redirect("xiangmu11Add.aspx?id=" + tickedFormNo + "&temp1=" + temp1 + "&temp2=" + temp2 + "&temp3=" + temp3 + "&temp4=" + temp4 + "&temp5=" + temp5 + "&temp6=" + temp6 + "&temp7=" + temp7 + "", false);
                    break;
                }
            }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            string str = "项目审计管理" + dt.ToString("yyyyMMddhhmmss");
            str = str + ".xlsx";
            //GridBind("download");
            ...
            MojoCube.Api.NPOIHelp.NPOIHelp.ExportXlsx("/Admin/DownLoadTemplates/项目审计管理下载模板.xlsx", downloadTable, str);
        }
