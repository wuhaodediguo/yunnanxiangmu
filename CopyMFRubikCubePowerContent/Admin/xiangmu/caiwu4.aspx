<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true" CodeBehind="caiwu4.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.caiwu4" %>
    ...
    <div class="mainWrap clearfix">
       <div class="main_tit" style="height:35px; margin-top:-10px;">
            <div>
                ...
                <font size="2px">财务管理</font>&gt;<font size="2px">发票管理</font>
                <em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</em>
            </div>
        </div>
        <div class="main_con">
            ...
            <div class="col-sm-12" style="width: 88%; height: 600px;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom: 0px;
                        ...
                        <h4 class="panel-title">
                            <strong><font color="blue" size="2px" font-weight="bold">发票管理列表</font></strong>
                        </h4>
                    </div>
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="TextBox9" runat="server" class="form-control input-sm" Width="200px"
                                            Text="发票价税开票合计金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                            border: 0; margin-left: 0px;"></asp:TextBox>
                                    </td>
                                    <td>
                ...
                <div class="row" style="margin: 5px auto; font-size: 12px; width: 100%; ">
                    ...
                    <div class="col-sm-1 " runat="server" id="div管理">
                        <asp:Button ID="Button3" runat="server" Text="管理" CssClass="btn11" Width="55px" OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                            OnClick="btn编辑_Click" />
                    </div>
                    ...
                    <div class="col-sm-1 ">
                        <asp:Button ID="Button1" runat="server" Text="明细导出" CssClass="btn11" Width="65px" OnClick="btnExport2_Click" />
                    </div>
                    <div class="col-sm-1 ">
                        <asp:Button ID="Button5" runat="server" Text="删除" CssClass="btn11" Visible="false" OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                            OnClick="btn删除_Click" />
                    </div>
                    <div class="col-sm-6 col-sm-offset-2">
                        <asp:Label ID="Label合计1" TabIndex="13" Width= "300px"  Style="margin-left: 100px; border:0; font-size:12px; color:red" 
                                            runat="server" class="form-control input-sm" autocomplete="off" ></asp:Label>
                    ...
                    <div class="table-responsive" style="width: 100%">
                        <asp:GridView ID="GridView1" runat="server" Font-Size="12px" HeaderStyle-Height="10px"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="发票单号" HeaderStyle-CssClass="text-center" >
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="合同类型" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol8" runat="server" Text='<%# Bind("col8") %>' Width="80px" Style="text-align: center;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="跨区域涉税事项报验管理编号" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol13" runat="server" Text='<%# Bind("col13") %>' Width="160px" Style="text-align: center;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="项目经理" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol4" runat="server" Text='<%# Bind("col4") %>' Width="90px"
                                            Style="text-align: center;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="发票价税开票小计金额" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol54" runat="server" Text='<%# Bind("col54") %>' Width="120px"
                                            Style="text-align: center;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="发票价税开票合计金额" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol544" runat="server"  Text='<%# Bind("col666") %>' Width="120px"
                                            Style="text-align: center;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="申请人" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                 ...
                                 <asp:TemplateField HeaderText="申请日期" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol2" runat="server" Text='<%# Bind("col2") %>' Width="110px"
                                            Style="text-align: center;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="开票人" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol31" runat="server" Text='<%# Bind("col31") %>' Width="90px"
                                            Style="text-align: center;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="开票日期" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol32" runat="server" Text='<%# Bind("col32") %>' Width="110px"
                                            Style="text-align: center;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="发票状态" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol55" runat="server" Text='<%# Bind("col33") %>' Width="80px"
                                            Style="text-align: center;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="发票作废/冲红说明" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol34" runat="server" Text='<%# Bind("col34") %>' Width="130px"
                                            Style="text-align: center;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="发票记账联扫描件" HeaderStyle-CssClass="text-center" >
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtn1" runat="server"   Text="下载" Width="120px" Visible="false"
                                                         CommandName="lbtn11">
                                                         </asp:LinkButton>
                                        <asp:CheckBox ID="Chk发票记账联扫描件" runat="server" Visible="false" Width="120px"></asp:CheckBox>
                                        <asp:HyperLink ID="HyperLinkcol发票记账联扫描件" runat="server" NavigateUrl='<%# Eval("col35") %>'
                                            Target="_blank" Width="120px" Style="text-align: center;" Visible="false">下载</asp:HyperLink>
                                        <asp:Label ID="lbl发票记账联扫描件" Visible="false" runat="server" Text='<%# Bind("col35") %>'></asp:Label>
                                        <asp:Label ID="Label发票记账联扫描件" Visible="false" runat="server" Width="120px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="发票发票联扫描件" HeaderStyle-CssClass="text-center" >
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtn2" runat="server" Text="下载" Width="120px"
                                                         CommandName="lbtn12">
                                            </asp:LinkButton>
                                        <asp:CheckBox ID="Chk发票发票联扫描件" runat="server" Visible="false" Width="120px"></asp:CheckBox>
                                        <asp:HyperLink ID="HyperLinkcol发票发票联扫描件" runat="server" NavigateUrl='<%# Eval("col36") %>'
                                            Target="_blank" Width="120px" Style="text-align: center;" Visible="false">下载</asp:HyperLink>
                                        <asp:Label ID="lbl发票发票联扫描件" Visible="false" runat="server" Text='<%# Bind("col36") %>'></asp:Label>
                                        <asp:Label ID="Label发票发票联扫描件" Visible="false" runat="server" Width="120px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="税票扫描件" HeaderStyle-CssClass="text-center" >
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtn3" runat="server" Text="下载" Width="120px"
                                                         CommandName="lbtn13">
                                            </asp:LinkButton>
                                        <asp:CheckBox ID="Chk税票扫描件" runat="server" Visible="false" Width="120px"></asp:CheckBox>
                                        <asp:HyperLink ID="HyperLinkcol税票扫描件" runat="server" NavigateUrl='<%# Eval("col37") %>'
                                            Target="_blank" Width="120px" Style="text-align: center;" Visible="false">下载</asp:HyperLink>
                                        <asp:Label ID="lbl税票扫描件" Visible="false" runat="server" Text='<%# Bind("col37") %>'></asp:Label>
                                        <asp:Label ID="Label税票扫描件" Visible="false" runat="server" Width="120px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="发票作废/冲红附件" HeaderStyle-CssClass="text-center" >
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtn4" runat="server" Text="下载" Width="120px"
                                                         CommandName="lbtn14">
                                            </asp:LinkButton>
                                        <asp:CheckBox ID="Chk发票作废冲红附件" runat="server" Visible="false" Width="150px"></asp:CheckBox>
                                        <asp:HyperLink ID="HyperLinkcol发票作废冲红附件" runat="server" NavigateUrl='<%# Eval("col38") %>'
                                            Target="_blank" Width="120px" Style="text-align: center;" Visible="false">下载</asp:HyperLink>
                                        <asp:Label ID="lbl发票作废冲红附件" Visible="false" runat="server" Text='<%# Bind("col38") %>'></asp:Label>
                                        <asp:Label ID="Label发票作废冲红附件" Visible="false" runat="server" Width="120px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
