<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true" CodeBehind="caiwu32.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.caiwu32" %>
            ...
            <div class="col-sm-12" style="width: 88%; height: 600px;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom: 0px;
                        ...
                        <h4 class="panel-title">
                            <strong><font color="blue" size="2px" font-weight="bold">已缴税款明细列表</font></strong>
                        </h4>
                    </div>
                                ...
                                <asp:TemplateField HeaderText="申请人" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol1" runat="server" Text='<%# Bind("col1") %>' Width="90px"
                                            Style="text-align: Left;" autocomplete="center"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
