<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true" CodeBehind="xiangmu5.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.xiangmu5" %>
            ...
            <div class="panel panel-default" style="width: 100%; height:600px; overflow: auto; margin-top: -5px;background-color:transparent;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom:0px; height: 35px; font-size: 10px;background-color: RGB(217,237,247); ">
                    <h4 class="panel-title" >
                       <strong><font color="blue" size="2px" font-weight="bold">项目资料已上传明细列表</font></strong> </h4>
                ...
                <div class="row" style="margin: 5px auto; font-size: 12px; width: 100%;">
                    ...
                    <div class="col-sm-1 ">
                        <asp:Button ID="Button3" runat="server" Text="导出" CssClass="btn11" Width="60px"  OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                            OnClick="btnExport_Click" />
                    </div>
                    <div class="col-sm-1 " runat="server" id="div资料重提" Visible="false">
                        <asp:Button ID="Button1" runat="server" Text="资料重提" CssClass="btn11" Width="60px"  OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                            OnClick="btn资料打回_Click" />
                    </div>
                    <div class="col-sm-1 " runat="server" id="div资料审核" Visible="false">
                        <asp:Button ID="Button5" runat="server" Text="资料审核"  CssClass="btn11" Width="60px"  OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                            OnClick="btn资料审核_Click" />
                    </div>
                    <div class="col-sm-1 ">
                        <asp:Button ID="Button7" runat="server" Text="已审核资料" CssClass="btn11" Width="70px"  OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                            OnClick="btn已审核资料_Click" />
                    </div>
                    <div class="col-sm-1 ">
                        <asp:Button ID="Button4" runat="server" Text="返回" CssClass="btn11"  OnClick="btnback_Click" />
                    </div>
                    ...
                    <div class="table-responsive" style="width: 100%">
                        ...
                        <RowStyle HorizontalAlign="Center" CssClass="" VerticalAlign="Middle" Height="5px"  />
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="结算类型" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Left"
                                    >
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="开票金额"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol16" runat="server" Text='<%# Bind("col22") %>' Width="110px"  style=" text-align:center;"
                                ...
                                <asp:TemplateField HeaderText="货物、服务名称"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="left" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol23" runat="server" Text='<%# Bind("col23") %>' Width="100px"  style=" text-align:left;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="发票类型"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol39" runat="server" Text='<%# Bind("col39") %>' Width="100px"  style=" text-align:center;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="发票类别"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol40" runat="server" Text='<%# Bind("col40") %>' Width="100px"  style=" text-align:center;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="税率"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol20" runat="server" Text='<%# Bind("col29") %>' Width="100px"  style=" text-align:center;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="开票日期"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol42" runat="server" Text='<%# Bind("col42") %>' Width="110px"  style=" text-align:center;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="创建人"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol13" runat="server" Text='<%# Bind("col41") %>' Width="90px"  style=" text-align:center;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="创建日期"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol14" runat="server" Text='<%# Bind("col42") %>' Width="110px" style=" text-align:center;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="备注"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="left" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol15" runat="server" Text='<%# Bind("col48") %>' Width="150px"  style=" text-align:left;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
