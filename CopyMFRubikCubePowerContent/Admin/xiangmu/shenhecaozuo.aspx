<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shenhecaozuo.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.shenhecaozuo" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function GetValueFromWindowOpen(object) {
            ...
            if (object.purpose == 'Allshenherenyuan') {
                            ...
                            <td colspan="3">
                                <div class="input-group">
                                    ...
                                    <span runat="server" id="span总包合同名称">
                                        <button type="button" class="btn btn-default " onclick="QueryByWindowOpen('Allshenherenyuan','TextBox合同名称', true,'合作合同');">
