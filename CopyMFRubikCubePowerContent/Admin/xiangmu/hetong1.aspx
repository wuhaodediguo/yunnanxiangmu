<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true"
    CodeBehind="hetong1.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.hetong1" %>
            ...
            <div class="panel panel-default" style="width: 100%; height:600px; overflow: auto; margin-top: -5px;background-color:transparent;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom:0px; height: 35px; font-size: 10px;background-color: RGB(217,237,247); ">
                    <h4 class="panel-title" >
                       <strong><font color="blue" size="2px" font-weight="bold">施工合同管理列表</font></strong> </h4>
                ...
                <div class="row" style="margin: 5px auto; font-size: 12px; width: 100%;">
                    ...
                    <div class="col-sm-1 " runat="server" id="div03" Visible="false">
                        ...
                        <RowStyle HorizontalAlign="Center" CssClass="" VerticalAlign="Middle" Height="5px"  />
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="序号" HeaderStyle-CssClass="text-center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lbl序号" runat="server" Text=' <%# Container.DataItemIndex + 1 %>' Width="30px" Height="20" style=" text-align:center;"> </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="实施项目部"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol8" runat="server" Text='<%# Bind("col8") %>' Width="130px"  style=" text-align:center;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="项目经理"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol9" runat="server" Text='<%# Bind("col9") %>' Width="80px"  style=" text-align:center;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="项目经理电话"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol10" runat="server" Text='<%# Bind("col10") %>' Width="80px" style=" text-align:center;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="建设单位联系人"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                ...
                                <asp:TemplateField HeaderText="建设单位联系电话"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="合同开工日期"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol14" runat="server" Text='<%# Bind("col14") %>' Width="120px"  style=" text-align:center;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="合同完工日期"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol15" runat="server" Text='<%# Bind("col15") %>' Width="120px"  style=" text-align:center;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="总工期"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol18" runat="server" Text='<%# Bind("col18") %>' Width="150px" style=" text-align:center;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="创建日期"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol17" runat="server" Text='<%# Bind("col17") %>' Width="110px"  CssClass="text-center"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="电子版合同"  HeaderStyle-CssClass="text-center" >
                                    ...
                                    <asp:LinkButton ID="lbtn1" runat="server"   Text="下载" Width="120px" Visible="false"
                                         ...
                                         <asp:HyperLink ID="HyperLinkcol17" runat="server" NavigateUrl= '<%# Eval("col19") %>' Target="_blank" Width="120px" style=" text-align:center;" Visible="false">下载</asp:HyperLink>
                                        <asp:Label ID="lbl电子版合同" Visible="false" runat="server" Text='<%# Bind("col19") %>' ></asp:Label>
                                        <asp:Label ID="Label电子版合同" Visible="false" runat="server" Width="120px" Height="1px" ></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="合同扫描件"  HeaderStyle-CssClass="text-center" >
                                    ...
                                    <asp:CheckBox ID="Chk合同扫描件" runat="server" Visible="false" Width="120px" ></asp:CheckBox>
                                        <asp:LinkButton ID="lbtn2" runat="server" Text="下载" Width="120px"
                                         ...
                                         <asp:HyperLink ID="HyperLinkcol18" runat="server" NavigateUrl= '<%# Eval("col20") %>' Target="_blank"  Width="120px" style=" text-align:center;" Visible="false">下载</asp:HyperLink>
                                        <asp:Label ID="lbl合同扫描件" Visible="false" runat="server" Text='<%# Bind("col20") %>' ></asp:Label>
                                         <asp:Label ID="Label合同扫描件" Visible="false" runat="server" Width="120px" ></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="合同其他附件"  HeaderStyle-CssClass="text-center" >
                                    ...
                                    <asp:LinkButton ID="lbtn3" runat="server" Text="下载" Width="120px"
                                         ...
                                         <asp:HyperLink ID="HyperLinkcol19" runat="server" NavigateUrl= '<%# Eval("col21") %>' Target="_blank"  Width="120px" style=" text-align:center;" Visible="false">&nbsp;&nbsp;下载&nbsp;&nbsp;</asp:HyperLink>
                                        <asp:Label ID="lbl合同其他附件" Visible="false" runat="server" Text='<%# Bind("col21") %>' ></asp:Label>
                                         <asp:Label ID="Label合同其他附件" Visible="false" Height="1px" runat="server" Width="120px" ></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="备注"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="left" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol20" runat="server" Text='<%# Bind("col22") %>' Width="150px"  style=" text-align:left;"
                                            autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
