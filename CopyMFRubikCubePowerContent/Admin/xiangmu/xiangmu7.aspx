<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true" CodeBehind="xiangmu7.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.xiangmu7" %>
            ...
            <div class="panel panel-default" style="width: 100%; height:600px; overflow: auto; margin-top: -5px;background-color:transparent;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom:0px; height: 35px; font-size: 10px;background-color: RGB(217,237,247); ">
                    <h4 class="panel-title" >
                       <strong><font color="blue" size="2px" font-weight="bold">项目资料已审核明细列表</font></strong> </h4>
                ...
                <div class="row" style="margin: 5px auto; font-size: 12px; width: 100%;">
                    ...
                    <%--<div class="col-sm-1 ">
                        <asp:Button ID="Button1" runat="server" Text="资料重提" Visible="false" CssClass="btn11" Width="60px"  OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                            OnClick="btn资料打回_Click" />
                    </div>
                    <div class="col-sm-1 ">
                        <asp:Button ID="Button5" runat="server" Text="资料审核" Visible="false" CssClass="btn11" Width="60px"  OnClientClick="RotateAnimation(this); return ShowProgressBar();"
