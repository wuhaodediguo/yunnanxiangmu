<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true"
    CodeBehind="caiwu3Add.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.caiwu3Add" %>
        ...
        function tongji() {
            ...
            for (var i = 1; i < gvPartOpen.rows.length; i++) {
                ...
                if (i == gvPartOpen.rows.length - 1) {
                    gvPartOpen.rows[i].cells[4].innerText = amount3;
                    gvPartOpen.rows[i].cells[5].innerText = amount4;
                    gvPartOpen.rows[i].cells[6].innerText = formatNumberHeader(amount5);
                    gvPartOpen.rows[i].cells[7].innerText = formatNumberHeader(amount6);
                    
                }
                var tempPrice2 = 0;
                var tPrice2 = "";
                var Price2 = gvPartOpen.rows[i].cells[5].getElementsByTagName("input")[0].value.replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "");
                var Price3 = gvPartOpen.rows[i].cells[6].getElementsByTagName("input")[0].value.replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "");

                var Price4 = gvPartOpen.rows[i].cells[7].getElementsByTagName("input")[0].value.replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "");
...
//                        amount4 = Price2 + "%";
//                    }
////                    gvPartOpen.rows[i].cells[5].getElementsByTagName("input")[0].value = Price2 + "%";
////                    gvPartOpen.rows[i].cells[6].getElementsByTagName("input")[0].value = formatNumberHeader(amount);

////                    amount2 = formatAsNum(Price1) + formatAsNum(amount);
////                    gvPartOpen.rows[i].cells[7].getElementsByTagName("input")[0].value = formatNumberHeader(amount2);
//                    amount3 += formatAsNum(Price1);
//                    amount5 += formatAsNum(Price3);
//                    amount6 += formatAsNum(Price4);
//                }
                if (Price1) {
                    amount3 += formatAsNum(Price1);
                }
    ...
    <asp:TextBox ID="TextBox审批说明情况" runat="server" class="form-control" Style="display: none"></asp:TextBox>
            ...
            <div class="col-sm-12" style="width: 88%;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom: 0px;
                    ...
                    <h4 class="panel-title">
                        <strong><font color="blue" size="2px">发票明细管理</font></strong>
                    </h4>
                </div>
                <div class="tab-content" style="margin: 0px auto; font-size: 12px;">
                    <table>
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="TextBox开票申请单号" TabIndex="12" Style="margin-left: 0px" Width="950px"
                                    onfocus="this.blur();" runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblTextBox38" runat="server" class="form-control input-sm" Width="190px" Height="50px"
                                        Text="<font color='red'>*</font>发票记账联扫描件：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                        border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:FileUpload ID="FileUpload1" TabIndex="31" runat="server" Style="margin-left: 1px;" />
                                    ...
                                    <a href="" runat="server" id="发票记账联扫描件href" target="_blank" style="font-size:12px;" Visible="false"></a>
                            ...
                            <td>
                                <asp:Label ID="lblTextBox40" runat="server" class="form-control input-sm" Width="190px" Height="50px"
                                        Text="<font color='red'>*</font>发票发票联扫描件：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                                        background-color: RGB(214,220,228); border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:FileUpload ID="FileUpload2" TabIndex="33" runat="server" Style="margin-left: -50px;" />
                                    <asp:Button ID="Button5" runat="server" Text="上传" TabIndex="34" Style="font-size: 12px;
                                        margin-left: -50px;" OnClick="FileUpload发票发票联扫描件Button_Click" CssClass="btn22" OnClientClick="RotateAnimation(this); return ShowProgressBar();"/>
                                    <asp:TextBox ID="TextBox发票发票联扫描件" runat="server" class="form-control input-sm" Style="display: none"></asp:TextBox>
                                    <a href="" runat="server" id="发票发票联扫描件href" target="_blank" style="font-size:12px;" Visible="false"></a>
                ...
                <div class="table-responsive" style="width: 1140px; overflow: auto; height: 550px;">
                    <asp:GridView ID="GridView1" runat="server" Font-Size="12px" HeaderStyle-Height="15px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="序号">
                                <ItemTemplate>
                                    <asp:Label ID="lbl序号" runat="server" Text=' <%# Container.DataItemIndex + 1 %>' Width="50px"
                            ...
                            <asp:TemplateField HeaderText="发票号码" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtcol12" runat="server"  Style="text-align: center;
                                        border: 0; height: 18px; font-size: 12px;" Text='<%# Bind("col2") %>' autocomplete="off"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="发票不含税金额" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtcol13" runat="server"  Style="text-align: left;
                                        border: 0; height: 18px; font-size: 12px;" Text='<%# Bind("col3") %>' 
                            ...
                            <asp:TemplateField HeaderText="税率" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtcol14" runat="server"  Style="text-align: center;
                                        border: 0; height: 18px; font-size: 12px;" Text='<%# Bind("col4") %>' autocomplete="off" 
                                        onblur='QtyCheck(this);tongji();'></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="税额" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtcol15" runat="server"  Style="text-align: left;
                                        border: 0; height: 18px; font-size: 12px;" Text='<%# Bind("col5") %>' onblur='QtyCheck(this);tongji();'
                            ...
                            <asp:TemplateField HeaderText="发票价税合计金额" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                <ItemTemplate>
                                    <div>
                                        <asp:TextBox ID="txtcol16" runat="server" Text='<%# Bind("col6") %>' Width="200px" onblur='QtyCheck(this);tongji();'
                                            Style="text-align: center; border: 0; height: 18px;" autocomplete="off"></asp:TextBox>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="备注" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="left">
                                <ItemTemplate>
                                    <div>
                                        <asp:TextBox ID="txtcol17" runat="server" Text='<%# Bind("col7") %>' Width="200px"
                                            Style="text-align: left; border: 0; height: 18px;" autocomplete="off"></asp:TextBox>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                ...
                <div class="row">
                    <div class="col-sm-1 ">
                        <asp:Button ID="btnDownloadTemplate" runat="server" Text="下载模板" CssClass="btn btn-link"
                            OnClick="btnDownloadTemplate_Click" CausesValidation="false"></asp:Button>
                    </div>
                    <div class="col-sm-1 ">
