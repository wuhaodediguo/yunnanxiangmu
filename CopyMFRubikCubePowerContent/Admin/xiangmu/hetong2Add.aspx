<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true"
    CodeBehind="hetong2Add.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.hetong2Add" %>
    ...
    <script type="text/javascript">
        ...
        function GetValueFromWindowOpen(object) {
            ...
            if (object.purpose == 'Allhetongshi') {
                ...
                var hide4 = document.getElementById('<%=TextBox专业.ClientID %>');
                var hide5 = document.getElementById('<%=TextBox地州市.ClientID %>');
                
                var hide6 = document.getElementById('<%=TextBox建设单位.ClientID %>');
                var hide7 = document.getElementById('<%=TextBox施工单位.ClientID %>');
                var hide8 = document.getElementById('<%=TextBox合同签订日期.ClientID %>');
            ...
            if (object.purpose == 'Alldanwei2') {
                ...
                var hide1 = document.getElementById('<%=TextBox分包单位.ClientID %>');
                hide1.value = object.col1;
            }

            if (object.purpose == 'Alldanwei22') {
                var hide1 = document.getElementById('<%=TextBox劳务单位.ClientID %>');
                hide1.value = object.col1;
            }
            ...
            <div class="main_conL222" style="width: 12%; background-color: RGB(155,194,230); font-size: 14px;">
                <dl style="width:120px; height:100%;">
                        ...
                        <dd runat="server" id="dd0032">
                            ...
                            <asp:Label ID="Label8" runat="server" Text="合作合同管理" Font-Size="14px"></asp:Label></font></a></dd>
                        <dd runat="server" id="dd0033">
                            <a runat="server" id="div0033" href="hetong3.aspx"><font color="blue">
                            <asp:Label ID="Label9" runat="server" Text="采购合同管理" Font-Size="14px"></asp:Label></font></a></dd>
                        <dd runat="server" id="dd0034">
                            <a runat="server" id="div0034" href="hetong4.aspx"><font color="blue">
                                <asp:Label ID="Label10" runat="server" Text="合同综合信息" Font-Size="14px"></asp:Label></font></a></dd>
                    </dl>
            ...
            <div class="col-sm-12" style="width: 88%;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom: 0px; width:1120px;
                    ...
                    <h4 class="panel-title">
                        <strong><font color="blue" size="2px" >合作合同新增管理</font></strong>
                    </h4>
                </div>
                ...
                <div class="tab-content" style="margin: 0px auto; font-size: 9px;">
                    <table>
                        <tr>
                            ...
                            <td colspan="5">
                                <div class="input-group">
                                    <asp:TextBox ID="txt合同名称" TabIndex="11" Style="margin-left: 0px" Width="927px" runat="server"
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblBox1" runat="server" class="form-control input-sm" Width="160px"
                                    Text="专业：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox专业" TabIndex="12" Style="margin-left: 0px" Width="240px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblBox2" runat="server" class="form-control input-sm" Width="160px"
                                    Text="地（州）市：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox地州市" TabIndex="15" Style="margin-left: 0px" Width="160px"
                                    runat="server" class="form-control input-sm" autocomplete="off" ></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblBox32" runat="server" class="form-control input-sm" Width="160px"
                                    Text="合同签订日期：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <asp:TextBox ID="TextBox建设单位" TabIndex="13" Style="margin-left: 0px" Width="400px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                            <td>
                            ...
                            <td colspan="2">
                                <asp:TextBox ID="TextBox施工单位" TabIndex="14" Style="margin-left: 0px" Width="400px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label5" runat="server" class="form-control input-sm" Width="160px"
                                    Text="<font color='red'>*</font>实施项目部：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <%--<asp:TextBox ID="TextBox所属项目部" TabIndex="14" Style="margin-left: 0px" Width="240px"
                                    runat="server" class="form-control input-sm" autocomplete="off" ></asp:TextBox>--%>
                               <asp:Dropdownlist ID="Drop所属项目部" TabIndex="13" Style="margin-left: 0px" Width="240px"
                            ...
                            <td>
                                <asp:Label ID="Label6" runat="server" class="form-control input-sm" Width="160px"
                                    Text="<font color='red'>*</font>项目经理：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td >
                                <asp:TextBox ID="TextBox项目经理" TabIndex="14" Style="margin-left: 0px" Width="160px" runat="server"
                                    class="form-control input-sm" autocomplete="off"></asp:TextBox>
                               
                            </td>
                            <td>
                                <asp:Label ID="Label7" runat="server" class="form-control input-sm" Width="160px"
                        ...
                        <tr>
                            <td>
                             ...
                             <td >
                                <asp:Dropdownlist ID="Drop所属项目部2" TabIndex="13" Style="margin-left: 0px" Width="240px"
                                ...
                                <%--<asp:TextBox ID="TextBox所属项目部2" TabIndex="14" Style="margin-left: 0px" Width="240px"
                                    runat="server" class="form-control input-sm" autocomplete="off" ></asp:TextBox>--%>
                             </td>
                            <td>
                             ...
                             <td>
                                <asp:TextBox ID="TextBox项目经理2" TabIndex="14" Style="margin-left: 0px" Width="160px" runat="server"
                                    class="form-control input-sm" autocomplete="off"></asp:TextBox>
                        ...
                        <tr>
                            <td>
                             ...
                             <td >
                                <asp:Dropdownlist ID="Drop所属项目部3" TabIndex="13" Style="margin-left: 0px" Width="240px"
                               ...
                               <%-- <asp:TextBox ID="TextBox所属项目部3" TabIndex="14" Style="margin-left: 0px" Width="240px"
                                    runat="server" class="form-control input-sm" autocomplete="off"  ></asp:TextBox>--%>
                             </td>
                            <td>
                             ...
                             <td>
                                <asp:TextBox ID="TextBox项目经理3" TabIndex="14" Style="margin-left: 0px" Width="160px" runat="server"
                                    class="form-control input-sm" autocomplete="off"></asp:TextBox>
                               
                             </td>
                             <td>
                                <asp:TextBox ID="TextBoxa2" runat="server" class="form-control input-sm" Width="160px"
                                        Text="项目经理电话：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                        border: 0; margin-left: 0px;"></asp:TextBox>
                             </td>
                             <td >
                        ...
                        <tr>
                             <td>
                                <asp:Label ID="lblBox35" runat="server" class="form-control input-sm" Width="160px"
                                    Text="<font color='red'>*</font>分包合同名称：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="5">
                                <asp:TextBox ID="TextBox分包合同名称" TabIndex="13" Style="margin-left: 0px" Width="960px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                             <td>
                                <asp:Label ID="lblBox3" runat="server" class="form-control input-sm" Width="160px"  Height="48px"
                                    Text="<font color='red'>*</font>分包合同结算依据：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="5" >
                                <asp:TextBox ID="TextBox分包合同结算依据" TabIndex="13" Style="margin-left: 0px" Width="960px" Rows="2" TextMode="MultiLine"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblBox34" runat="server" class="form-control input-sm" Width="160px"
                                    Text="<font color='red'>*</font>分包单位：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <div class="input-group">
                                    <asp:TextBox ID="TextBox分包单位" TabIndex="19" Style="margin-left: 0px" Width="367px"
                                        onfocus="this.blur();" runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                                    <span class="input-group-btn" runat="server" id="span分包单位">
                                        <button type="button" class="btn btn-default btn-sm" onclick="QueryByWindowOpen('Alldanwei2','TextBox1', true,'<%=hd合同类型.ClientID %>');">
                                            <span class="glyphicon glyphicon-search" aria-hidden="true" align="left"></span>
                                        </button>
                                    </span>
                                </div>
                            ...
                            <td>
                                <asp:Label ID="Label2" runat="server" class="form-control input-sm" Width="160px"
                                    Text="<font color='red'>*</font>分包合同编号：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="TextBox分包合同编号" TabIndex="13" Style="margin-left: 0px" Width="400px"
                                    runat="server" class="form-control input-sm" autocomplete="off" ></asp:TextBox>
                            </td>
                        ...
                        <tr>
                           <td>
                                <asp:Label ID="lblBox36" runat="server" class="form-control input-sm" Width="160px"
                                    Text="<font color='red'>*</font>分包合同金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td >
                                <asp:TextBox ID="TextBox分包合同金额" TabIndex="11" Style="margin-left: 0px" Width="240px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onblur='NumberCheck(this)'></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblBox37" runat="server" class="form-control input-sm" Width="160px"
                                    Text="<font color='red'>*</font>分包合同签订日期：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox分包合同签订日期" TabIndex="13" Style="margin-left: 0px" Width="160px"
                            ...
                            <td>
                                <asp:Label ID="Label1" runat="server" class="form-control input-sm" Width="160px"
                                    Text="<font color='red'>*</font>分包合同结算比例：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td >
                                <asp:TextBox ID="TextBox分包合同结算比例" TabIndex="11" Style="margin-left: 0px" Width="240px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblBox24" runat="server" class="form-control input-sm" Width="160px"
                                    Text="<font color='red'>*</font>劳务合同名称：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="5">
                                <asp:TextBox ID="TextBox劳务合同名称" TabIndex="13" Style="margin-left: 0px" Width="960px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                             <td>
                                <asp:Label ID="lblBox7" runat="server" class="form-control input-sm" Width="160px"  Height="48px"
                                    Text="<font color='red'>*</font>劳务合同结算依据：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="5" >
                                <asp:TextBox ID="TextBox劳务合同结算依据" TabIndex="13" Style="margin-left: 0px" Width="960px" Rows="2" TextMode="MultiLine"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblBox39" runat="server" class="form-control input-sm" Width="160px"
                                    Text="<font color='red'>*</font>劳务单位：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <div class="input-group">
                                    <asp:TextBox ID="TextBox劳务单位" TabIndex="19" Style="margin-left: 0px" Width="367px"
                                        onfocus="this.blur();" runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                                    <span class="input-group-btn" runat="server" id="span劳务单位">
                                        <button type="button" class="btn btn-default btn-sm" onclick="QueryByWindowOpen('Alldanwei22','TextBox2', true,'<%=hd合同类型.ClientID %>');">
                                            <span class="glyphicon glyphicon-search" aria-hidden="true" align="left"></span>
                                        </button>
                                    </span>
                                </div>
                            ...
                            <td>
                                <asp:Label ID="Label4" runat="server" class="form-control input-sm" Width="160px"
                                    Text="<font color='red'>*</font>劳务合同编号：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="TextBox劳务合同编号" TabIndex="13" Style="margin-left: 0px" Width="400px"
                                    runat="server" class="form-control input-sm" autocomplete="off" ></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                           <td>
                                <asp:Label ID="lblBox30" runat="server" class="form-control input-sm" Width="160px"
                                    Text="<font color='red'>*</font>劳务合同金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox劳务合同金额" TabIndex="14" Style="margin-left: 0px" Width="240px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onblur='NumberCheck(this)'></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblBox4" runat="server" class="form-control input-sm" Width="160px"
                                    Text="<font color='red'>*</font>劳务合同签订日期：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox劳务合同签订日期" TabIndex="13" Style="margin-left: 0px" Width="160px"
                                    runat="server" class="form-control input-sm" autocomplete="off" onclick="WdatePicker({lang:'zh-cn',dateFmt:'yyyy年-MM月-dd日'})"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="Label3" runat="server" class="form-control input-sm" Width="160px"
                                    Text="<font color='red'>*</font>劳务合同结算比例：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                    border: 0; margin-left: 0px;"></asp:Label>
                            </td>
                            <td >
                                <asp:TextBox ID="TextBox劳务合同结算比例" TabIndex="11" Style="margin-left: 0px" Width="240px"
                                    runat="server" class="form-control input-sm" autocomplete="off"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="TextBox38" runat="server" class="form-control input-sm" Width="160px" Height="52px"
                                        Text="分包电子版合同：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                        border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:FileUpload ID="FileUpload1" TabIndex="31" runat="server" Width="160px" Style="margin-left: 2px;" />
                                    <asp:Button ID="Button4" runat="server" Text="上传" TabIndex="32" Style="font-size: 12px;margin-left: 2px;"
                                        OnClick="FileUpload分包电子版合同Button_Click" CssClass="btn22" OnClientClick="RotateAnimation(this); return ShowProgressBar();"/>
                                    <asp:TextBox ID="TextBox分包电子版合同" runat="server" class="form-control" Width="160px" Style="display: none"></asp:TextBox>
                                    <a href="" runat="server" id="分包电子版合同href" target="_blank" style="font-size:12px;" Visible="false">分包电子版合同</a>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox40" runat="server" class="form-control input-sm" Width="158px" Height="52px"
                                        Text="劳务电子版合同：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                        border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:FileUpload ID="FileUpload2" TabIndex="33" runat="server" Width="154px" Style="margin-left: -2px;" />
                                    <asp:Button ID="Button5" runat="server" Text="上传" TabIndex="34" Style="font-size: 12px;margin-left: -2px;"
                                        OnClick="FileUpload劳务电子版合同Button_Click" CssClass="btn22" OnClientClick="RotateAnimation(this); return ShowProgressBar();"/>
                                    <asp:TextBox ID="TextBox劳务电子版合同" runat="server" class="form-control input-sm" Width="154px" Style="display: none"></asp:TextBox>
                                    <a href="" runat="server" id="劳务电子版合同href" target="_blank" style="font-size:12px; " Visible="false">劳务电子版合同</a>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox20" runat="server" class="form-control input-sm" Width="160px" Height="52px"
                                        Text="分包合同扫描件：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                        border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:FileUpload ID="FileUpload3" runat="server" TabIndex="35" Width="158px" Style="margin-left: 2px" />
                                    <asp:Button ID="Button6" runat="server" Text="上传" TabIndex="36" Style="font-size: 12px;
                                        margin-left: 2px" OnClick="FileUpload分包合同扫描件Button_Click" CssClass="btn22" OnClientClick="RotateAnimation(this); return ShowProgressBar();"/>
                                    <a href="" runat="server" id="分包合同扫描件href" target="_blank" style="font-size:12px;" Visible="false">分包合同扫描件</a>
                                    <asp:TextBox ID="TextBox分包合同扫描件" runat="server" class="form-control input-sm" Style="display: none"></asp:TextBox>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="TextBox18" runat="server" class="form-control input-sm" Width="160px" Height="52px"
                                        Text="劳务合同扫描件：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                        border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:FileUpload ID="FileUpload4" TabIndex="31" runat="server" Width="160px" Style="margin-left: 2px" />
                                    <asp:Button ID="Button1" runat="server" Text="上传" TabIndex="32" Style="font-size: 12px;margin-left: 2px"
                                        OnClick="FileUpload劳务合同扫描件Button_Click" CssClass="btn22" OnClientClick="RotateAnimation(this); return ShowProgressBar();"/>
                                    <asp:TextBox ID="TextBox劳务合同扫描件" runat="server" class="form-control" Width="160px" Style="display: none"></asp:TextBox>
                                    <a href="" runat="server" id="劳务合同扫描件href" target="_blank" style="font-size:12px;" Visible="false">劳务合同扫描件</a>
                            ...
                            <td>
                               <asp:TextBox ID="TextBox26" runat="server" class="form-control input-sm" Width="160px" Height="52px"
                                        Text="合同其他附件：" Font-Bold="true" ReadOnly="true" Style="text-align: right; background-color: RGB(214,220,228);
                                        border: 0; margin-left: 0px;"></asp:TextBox>
                            </td>
                            <td colspan="3">
                                <asp:FileUpload ID="FileUpload5" TabIndex="33" runat="server" Width="156px" Style="margin-left: 0px" />
                                    <asp:Button ID="Button2" runat="server" Text="上传" TabIndex="34"  Style="font-size: 12px;margin-left: 0px"
                                        OnClick="FileUpload合同其他附件Button_Click" CssClass="btn22" OnClientClick="RotateAnimation(this); return ShowProgressBar();"/>
