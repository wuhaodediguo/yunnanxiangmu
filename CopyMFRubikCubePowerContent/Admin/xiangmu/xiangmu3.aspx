<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true"
    CodeBehind="xiangmu3.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.xiangmu3" %>
                ...
                <div class="panel panel-default" style="width: 100%; height: 600px; overflow: auto;
                    ...
                    <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom: 0px;
                        ...
                        <h4 class="panel-title">
                            <strong><font color="blue" size="2px" font-weight="bold">项目综合管理列表</font></strong>
                        </h4>
                    </div>
                    <div class="panel panel-default" style="margin: 0px auto; font-size: 12px; width: 100%;">
                        ...
                        <div id="SearchArea" class="collapse">
                            <div class="panel-body" style="margin: -10px auto; font-size: 12px;">
                                ...
                                <div class="row" style="margin: 5px auto; font-size: 12px; width: 100%; height: 50%;">
                    ...
                    <div class="row" style="margin: 5px auto; font-size: 9px; width: 100%;">
                        <div class="col-sm-1 ">
                            <asp:Button ID="Button3" runat="server" Text="查看" CssClass="btn11" OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                                OnClick="btn查看_Click" />
                        </div>
                        <div class="col-sm-1 ">
                        ...
                        <div class="col-sm-1 ">
                            <asp:Button ID="Button1" runat="server" Text="明细导出" CssClass="btn11" Width="60" OnClick="btnExport2_Click" />
                        </div>
                        <div class="col-sm-7 col-sm-offset-1">
                            <asp:Label ID="Label合计1" TabIndex="13" Width="330px" Style="margin-left: -5px; border: 0;
                                font-size: 12px; color: red" runat="server" class="form-control input-sm" autocomplete="off"></asp:Label>
                            <asp:Label ID="Label合计2" TabIndex="13" Width="300px" Style="margin-left: -83px; border: 0;
                                font-size: 12px; color: red" runat="server" class="form-control input-sm" autocomplete="off"></asp:Label>
                            
                        </div>
                        <div class="row">
                            <div class="col-sm-7 col-sm-offset-4">
                                <asp:Label ID="Label合计3" TabIndex="13" Width="230px" Style="margin-left: 0px; border: 0;
                                font-size: 12px; color: red" runat="server" class="form-control input-sm" autocomplete="off"></asp:Label>
                            <asp:Label ID="Label合计4" TabIndex="13" Width="230px" Style="margin-left: 17px; border: 0;
                                font-size: 12px; color: red" runat="server" class="form-control input-sm" autocomplete="off"></asp:Label>
                            <asp:Label ID="Label合计5" TabIndex="13" Width="200px" Style="margin-left: 0px; border: 0;
                                font-size: 12px; color: red" runat="server" class="form-control input-sm" autocomplete="off"></asp:Label>
                             </div>   
                            ...
                            <asp:GridView ID="GridView1" runat="server" Font-Size="12px" HeaderStyle-Height="10px"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="开票日期" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl开票日期" runat="server" Width="110px" Style="text-align: center;"
                                                autocomplete="off"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="开票日期"  HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center" >
                                    ...
                                    <asp:TemplateField HeaderText="到账金额" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl到账金额" runat="server" Width="100px" Style="text-align: center;"
                                                autocomplete="off"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="未到账金额" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <asp:Label ID="lblcol29" runat="server" Width="100px" Style="text-align: center;"
                                                autocomplete="off"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="项目状态" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <asp:Label ID="lblcol30" runat="server" Text='<%# Bind("col30") %>' Width="100px"
                                                Style="text-align: center;" autocomplete="off"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
