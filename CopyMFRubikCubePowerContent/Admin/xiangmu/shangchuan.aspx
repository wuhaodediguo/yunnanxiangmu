<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true" CodeBehind="shangchuan.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.shangchuan" %>
    ...
    <div class="mainWrap clearfix">
        <div class="main_tit" style="height:35px; margin-top:-10px;">
            <div>
                ...
                市场管理&gt; <asp:Label ID="Label1" runat="server" Visible="false"></asp:Label>
                <em style="width:300%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <dl style="width: 120px; height: 100%;">
                    ...
                    <dd>
                        <a runat="server" id="div0022" href="shichang2.aspx"><font color="blue">
                            <asp:Label ID="Label2" runat="server" Text="中标管理" Font-Size="14px"></asp:Label></font></a></dd>
                    <dd>
                        <a runat="server" id="div0023" href="shichang3.aspx"><font color="blue">
                            <asp:Label ID="Label3" runat="server" Text="客商管理" Font-Size="14px"></asp:Label></font></a></dd>
                    <!--#endeditable-->
                </dl>
            </div>
