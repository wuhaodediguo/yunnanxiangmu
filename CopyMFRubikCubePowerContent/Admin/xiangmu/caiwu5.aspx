<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true" CodeBehind="caiwu5.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.caiwu5" %>
    ...
    <asp:TextBox ID="hdtemp" runat="server" class="form-control" Style="display: none"></asp:TextBox>
        <div class="main_tit" style="height:35px; margin-top:-10px;">
            <div>
                ...
                <font size="2px">财务管理</font>&gt;<font size="2px">收款管理</font>
                <em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</em>
            </div>
        </div>
        <div class="main_con">
            ...
            <div class="col-sm-12" style="width: 88%; height: 600px;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom: 0px;
                        ...
                        <h4 class="panel-title">
                            <strong><font color="blue" size="2px" font-weight="bold">收款管理列表</font></strong>
                        </h4>
                    </div>
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="TextBox10" runat="server" class="form-control input-sm" Width="200px"
                                            Text="发票价税开票合计金额：" Font-Bold="true" ReadOnly="true" Style="text-align: right;
                ...
                <div class="row" style="margin: 5px auto; font-size: 12px; width: 100%;">
                    ...
                    <div class="col-sm-1 " runat="server" id = "div收款确认" visible="false">
                        <asp:Button ID="Button3" runat="server" Text="收款确认"  CssClass="btn11" Width="60px" OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                            OnClick="btn编辑_Click" />
                    </div>
                    ...
                    <div class="col-sm-6 col-sm-offset-2">
                        <asp:Label ID="Label合计1"  Width= "260px"  Style="margin-left: 0px; border:0; font-size:12px; color:red" 
                                            runat="server" class="form-control input-sm" autocomplete="off" ></asp:Label>
                        <asp:Label ID="Label合计2"  Width= "260px" Style="margin-left: 0px; border:0; font-size:12px; color:red"  
                        ...
                        <asp:GridView ID="GridView1" runat="server" Font-Size="12px" HeaderStyle-Height="10px"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="付款单位名称" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="left"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol14" runat="server" Text='<%# Bind("col14") %>' Width="150px" Style="text-align: left;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="开票单位名称" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="left"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol15" runat="server" Text='<%# Bind("col15") %>' Width="120px" Style="text-align: left;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="项目属性" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="所属项目部" HeaderStyle-CssClass="text-center"
                                ...
                                <asp:TemplateField HeaderText="项目经理" HeaderStyle-CssClass="text-center"
                                    ItemStyle-HorizontalAlign="center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol4" runat="server" Text='<%# Bind("col4") %>' Width="160px"
                                            Style="text-align: center;"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="发票状态" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol55" runat="server" Text='<%# Bind("col55") %>' Width="150px"
                                            Style="text-align: center;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="申请日期" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                 ...
                                 <asp:TemplateField HeaderText="开票人" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol31" runat="server" Text='<%# Bind("col31") %>' Width="120px"
                                            Style="text-align: center;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="总计到账金额" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol41" runat="server" Text='<%# Bind("col59") %>' Width="100px"
                                            Style="text-align: center;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="到账情况" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol42" runat="server" Text='<%# Bind("col60") %>' Width="90px"
                                            Style="text-align: center;" autocomplete="off"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="备注" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Left"
                                    >
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol49" runat="server" Text='<%# Bind("col64") %>' Width="150px"
