<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true"
    CodeBehind="xiangmu1Add.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.xiangmu.xiangmu1Add" %>
            ...
            <div class="main_conL222" style="width: 12%; background-color: RGB(155,194,230); 
                ...
                <dl style="width: 120px; height: 100%;">
                    ...
                    <dd runat="server" id="dd0046">
                        ...
                        <font color="blue">
                            <asp:Label ID="Label219" runat="server" Text="项目月报管理" Font-Size="14px"></asp:Label></font></a></dd>
                </dl>
            </div>
            <div class="col-sm-12" style="width: 88%;">
                ...
                <div class="panel-heading" style="text-align: center; margin-top: 0px; margin-bottom: 0px; width:1120px;
                    ...
                    <h4 class="panel-title">
                        <strong><font color="blue" size="2px" >项目立项新增管理</font></strong>
                    </h4>
                </div>
