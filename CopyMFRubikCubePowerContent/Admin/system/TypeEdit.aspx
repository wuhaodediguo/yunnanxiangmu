<%@ Page Language="C#" masterpagefile="../Commons/Main.master" AutoEventWireup="true" CodeBehind="TypeEdit.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.system.Admin_System_TypeEdit" %>
          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              <div class="row">
                  ...
                  <div class="col-md-6 form-group">
                    <label><asp:Label ID="Label5" runat="server" Text="描述"></asp:Label></label>
