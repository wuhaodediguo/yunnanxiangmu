<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true" CodeBehind="company.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.BaseData.company" %>
          ...
          <div class="row">
            ...
            <div class="row">
                <div class="col-md-2 form-group" runat="server" visible="false" id="div01" >
                    <label><asp:Label ID="lblColumn3" runat="server" Text="部门"></asp:Label></label>
                ...
                <div class="box-body table-responsive no-padding">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" GridLines="None" BorderWidth="0px" CssClass="table table-hover" AllowSorting="True" OnSorting="GridView1_Sorting" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" OnRowCreated="GridView1_RowCreated" ShowFooter="True">
                         <Columns>
                            ...
                            <asp:TemplateField HeaderText="部门" SortExpression="">
                                <ItemTemplate>
                                    <asp:Label ID="lblColumn1" runat="server" Text='<%# Bind("companyname") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
