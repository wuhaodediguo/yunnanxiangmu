...
{
    public partial class company : MyPage, IRequiresSessionState
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!base.IsPostBack)
            {
                ...
                if (base.Request.QueryString["id"] != null)
                {
                    ...
                    MojoCube.Web.CurrentExpenses.companyList companyList = new MojoCube.Web.CurrentExpenses.companyList();
                    companyList.GetData(int.Parse(this.ViewState["ID"].ToString()));

                    txtpinming.Text = companyList.guige.ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            companyList.guige = txtpinming.Text.Trim();
            companyList.remark = "";

            if (this.ViewState["ID"] != null)
            {
                companyList.ID = int.Parse(this.ViewState["ID"].ToString());
                if (companyList.UpdateData() > 0)
                {
                    ...
                    base.Response.Redirect("company.aspx?active=" + base.Request.QueryString["active"]);
                }
                else
                {
        ...
        private void GridBind(string type = null)
        {
            ...
            adminPager.TableName = "tb_company";
            ...
            DataTable dt = (DataTable)ViewState["BindDll"];
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                ((HyperLink)e.Row.FindControl("gvEdit")).NavigateUrl = "company.aspx?id=" + str + "&active=" + base.Request.QueryString["active"];
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "_delete")
            {
                ...
                companyList.DeleteData(int.Parse(((Label)this.GridView1.Rows[index].FindControl("lblID")).Text));
            }
            this.GridBind();
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow r in GridView1.Rows)
            {
                if (((CheckBox)r.FindControl("uxDeleteCheckBox")).Checked)
                {
                    ...
                    companyList.DeleteData(int.Parse(((Label)r.FindControl("lblID")).Text.Trim()));
                }
            }
            this.GridBind();
        }
