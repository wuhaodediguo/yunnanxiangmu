...
{
    public partial class guigeEdit : MyPage, IRequiresSessionState
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!base.IsPostBack)
            {
                ...
                if (base.Request.QueryString["id"] != null)
                {
                    ...
                    zhuanyeList zhuanyeList = new zhuanyeList();
                    zhuanyeList.GetData(int.Parse(this.ViewState["ID"].ToString()));

                    txtpinming.Text = zhuanyeList.guige;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            zhuanyeList zhuanyeList = new zhuanyeList();
            zhuanyeList.guige = txtpinming.Text;


            if (this.ViewState["ID"] != null)
            {
                zhuanyeList.ID = int.Parse(this.ViewState["ID"].ToString());
                if (zhuanyeList.UpdateData() > 0)
                {
                    this.AlertDiv.InnerHtml = MojoCube.Web.String.ShowAlert("success", "数据保存成功");
                    //清空文本框
                    div01.Visible = false;

                    base.Response.Redirect("guigeEdit.aspx?active=" + base.Request.QueryString["active"]);
                }
        ...
        private void GridBind(string type = null)
        {
            ...
            sql = @"select * from zhuanye where 1=1 order by ID asc ";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                ((HyperLink)e.Row.FindControl("gvEdit")).NavigateUrl = "guigeEdit.aspx?id=" + str + "&active=" + base.Request.QueryString["active"];
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "_delete")
            {
                ...
                zhuanyeList.DeleteData(int.Parse(((Label)this.GridView1.Rows[index].FindControl("lblID")).Text));
            }
            this.GridBind();
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow r in GridView1.Rows)
            {
                ...
                {
                    zhuanyeList.DeleteData(int.Parse(((Label)r.FindControl("lblID")).Text.Trim()));
                }
            }
            this.GridBind();
        }
