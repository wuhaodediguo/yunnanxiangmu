...
{
    public partial class yewustyle : MyPage, IRequiresSessionState
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!base.IsPostBack)
            {
                ...
                if (base.Request.QueryString["id"] != null)
                {
                    ...
                    yewustyleList yewustyleList = new yewustyleList();
                    yewustyleList.GetData(int.Parse(this.ViewState["ID"].ToString()));

                    txtpinming.Text = yewustyleList.guige;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            yewustyleList.guige = txtpinming.Text.Trim();
      
            if (this.ViewState["ID"] != null)
            {
                yewustyleList.ID = int.Parse(this.ViewState["ID"].ToString());
                if (yewustyleList.UpdateData() > 0)
                {
                    this.AlertDiv.InnerHtml = MojoCube.Web.String.ShowAlert("success", "数据保存成功");
                    //清空文本框
                    div01.Visible = false;
                    
                    base.Response.Redirect("yewustyle.aspx?active=" + base.Request.QueryString["active"]);
                }
        ...
        private void GridBind(string type = null)
        {
            ...
            sql = @"select * from tb_yewustyle where 1=1 order by ID asc ";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                ((HyperLink)e.Row.FindControl("gvEdit")).NavigateUrl = "yewustyle.aspx?id=" + str + "&active=" + base.Request.QueryString["active"];
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "_delete")
            {
                ...
                yewustyleList.DeleteData(int.Parse(((Label)this.GridView1.Rows[index].FindControl("lblID")).Text));
            }
            this.GridBind();
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow r in GridView1.Rows)
            {
                ...
                {
                    yewustyleList.DeleteData(int.Parse(((Label)r.FindControl("lblID")).Text.Trim()));
                }
            }
            this.GridBind();
        }
