<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true"
    CodeBehind="guige.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.BaseData.guige" %>
        ...
        <div class="main_con">
            ...
            <div class="col-sm-10" style="width: 88%;">
                ...
                <div class="row" style="margin: 5px auto; font-size: 9px; width: 100%;">
                    ...
                    <div class="col-sm-1 ">
                        <asp:Button ID="btnSave" runat="server" Text="保存" CssClass="btn11" OnClick="btnSave_Click">
                        </asp:Button>
                    </div>
                    <div class="col-sm-1 ">
                    ...
                    <div class="col-sm-1 ">
                        <asp:Button ID="btnDelete" runat="server" Text="批量删除"  visible="false" CssClass="btn11" Width="70px"
                ...
                <div class="row">
                    <div class="col-md-2 form-group" runat="server" visible="false" id="div01">
                        <label>
                            <asp:Label ID="lblColumn3" runat="server" Text="所属项目部"></asp:Label></label>
