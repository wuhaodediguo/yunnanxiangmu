<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true"
    CodeBehind="xiangmujingli.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.BaseData.xiangmujingli" %>
        ...
        <div class="main_con">
            ...
            <div class="col-sm-10" style="width: 88%;">
                            ...
                            <div class="panel-body" style="margin: -10px auto; font-size: 12px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtcol1" TabIndex="13" Style="margin-left: 0px" Width="390px" runat="server"
                                                class="form-control input-sm" autocomplete="off"></asp:TextBox>
                                        </td>
                                        <td>
                                        <asp:Button ID="Button3" runat="server" Text="查询" CssClass="btn22" Style="margin-left: 10px" OnClientClick="RotateAnimation(this); return ShowProgressBar();"
                                            OnClick="btn查询_Click" />
                                        </td>
                                    </tr>
                                </table>
                ...
                <div class="row" style="margin: 5px auto; font-size: 9px; width: 100%;">
                    <div class="col-sm-1  ">
                        <asp:Button ID="btnAdd" runat="server" Text="新增" CssClass="btn11" OnClick="btnAdd_Click">
                        </asp:Button>
                    </div>
                    <div class="col-sm-1 ">
                        <asp:Button ID="btnSave" runat="server" Text="保存" CssClass="btn11" OnClick="btnSave_Click"> </asp:Button>
                    </div>
                    <div class="col-sm-1 ">
                            <asp:Button ID="Button4" runat="server" Text="导出" CssClass="btn11" OnClick="btnExport_Click" />
                        </div>
                    <div class="col-sm-1 ">
                        <asp:Button ID="Button2" runat="server" Text="全部勾选" CssClass="btn11" Width="70px" Visible="false"
                            OnClick="Button2_Click"></asp:Button>
                    </div>
                    <div class="col-sm-1 ">
                        <asp:Button ID="btnDelete" runat="server" Text="批量删除" CssClass="btn11" Width="70px" Visible="false"
                            OnClick="btnDelete_Click"></asp:Button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2 form-group" runat="server" visible="false" id="div2">
                        <label>
                            <asp:Label ID="lblColumn23" runat="server" Text="所属项目部"></asp:Label></label>
                        <asp:DropDownList ID="Drop所属项目部" TabIndex="13" Style="margin-left: 0px" Width="180px"
                    ...
                    <div class="col-md-2 form-group" runat="server" visible="false" id="div01">
                        <label>
                            <asp:Label ID="lblColumn3" runat="server" Text="项目经理"></asp:Label></label>
                                ...
                                <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False" BorderWidth="0px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="所属项目部" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblColumn3" runat="server" Text='<%# Bind("guige") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="项目经理" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl项目经理" runat="server" Text='<%# Bind("col2") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:CheckBox ID="uxDeleteCheckBox" runat="server" Width="30px"  style=" text-align:center;" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
