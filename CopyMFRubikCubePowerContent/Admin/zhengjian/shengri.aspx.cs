...
{
    public partial class shengri : System.Web.UI.Page
    {
        ...
        private void GridBind()
        {
            ...
            where.Append(" and format(sdate,'MMdd') like '%'+?+'%' ");
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                ((Label)e.Row.FindControl("lbl生日")).Text = ((Label)e.Row.FindControl("lbl生日")).Text == "" ? "" : Convert.ToDateTime(((Label)e.Row.FindControl("lbl生日")).Text).ToString("yyyy-MM-dd");
