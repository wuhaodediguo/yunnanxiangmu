...
{
    public partial class cheguoqi : System.Web.UI.Page
    {
        ...
        private void GridBind()
        {
            ...
            where.Append(" and format(jianchayouxiaodate,'yyyyMMdd') <= ''+?+'' ");
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                ((Label)e.Row.FindControl("lbl合同到期日期")).Text = Convert.ToDateTime(((Label)e.Row.FindControl("lbl合同到期日期")).Text).ToString("yyyy-MM-dd");
