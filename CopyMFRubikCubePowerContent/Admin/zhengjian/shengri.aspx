<%@ Page Language="C#" masterpagefile="../Commons/Main.master"  AutoEventWireup="true" CodeBehind="shengri.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.zhengjian.shengri" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" GridLines="None" BorderWidth="0px" CssClass="table table-hover" AllowSorting="True" OnSorting="GridView1_Sorting" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" OnRowCreated="GridView1_RowCreated">
                        <Columns>
                          ...
                          <asp:TemplateField HeaderText="出生日期">
                                <ItemTemplate>
                                    <asp:Label ID="lbl生日" runat="server" Text='<%# Bind("sdate") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
