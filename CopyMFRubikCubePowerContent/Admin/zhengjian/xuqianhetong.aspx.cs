...
{
    public partial class xuqianhetong : System.Web.UI.Page
    {
        ...
        private void GridBind()
        {
            ...
            where.Append(" and format(hetongcol3,'yyyyMMdd') <= ''+?+'' ");
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                ((Label)e.Row.FindControl("lbl合同签订日期")).Text = ((Label)e.Row.FindControl("lbl合同签订日期")).Text == "" ? "" : Convert.ToDateTime(((Label)e.Row.FindControl("lbl合同签订日期")).Text).ToString("yyyy-MM-dd");
