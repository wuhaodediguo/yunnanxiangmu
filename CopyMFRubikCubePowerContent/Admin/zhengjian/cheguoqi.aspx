<%@ Page Language="C#" masterpagefile="../Commons/Main.master" AutoEventWireup="true" CodeBehind="cheguoqi.aspx.cs" Inherits="CopyMFRubikCubePowerContent.Admin.zhengjian.cheguoqi" %>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">车辆检验有效期到期提醒</li>
          </ol>
        </section>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" GridLines="None" BorderWidth="0px" CssClass="table table-hover" AllowSorting="True" OnSorting="GridView1_Sorting" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" OnRowCreated="GridView1_RowCreated">
                        ...
                        ItemStyle-HorizontalAlign="Left" />
                            ...
                            <asp:TemplateField HeaderText="检验有效期">
                                <ItemTemplate>
                                    <asp:Label ID="lbl合同到期日期" runat="server" Text='<%# Bind("jianchayouxiaodate") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
